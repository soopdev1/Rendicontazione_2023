...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "generatedRimborso1B.jsp")) {
...
<html>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu_ente/menu_rimborso_1B.jsp"%>
            <!-- END MENU -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"><strong>1B</strong><small> DOMANDE IN ATTESA</small></h3>
                    ...
                    <div class="portlet box blue-soft" style="display: none;">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="generatedRimborso1B.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="generatedRimborso1B.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                ...
                                jQuery(document).ready(function () {
                                    var dt2 = function () {
                                        ...
                                        g.dataTable({
                                            ...
                                            processing: true,
                                            ajax: {
                                                url: "QueryEnte?type=4&stato=S&politica=A01&protocollo=<%=protocollo%>&from_up=<%=from_up%>&to_up=<%=to_up%>&from_mod=<%=from_mod%>&to_mod=<%=to_mod%>",
                                                dataSrc: "aaData",
                                                type: "GET"
                                            },
