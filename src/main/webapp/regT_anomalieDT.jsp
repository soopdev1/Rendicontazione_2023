...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "regT_anomalieDT.jsp")) {
...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function setAccettaID(id) {
                document.getElementById('confirmactive').href = 'OperazioniRegional?type=16&idregistri=' + id + '&tipo=A' + document.getElementById(id + '_pol').value + "&pagina=regT_anomalieDT"
            ...
            function submitScarto() {
                ...
                if (motivo1 == null || motivo1 == "..." || motivo1 == "") {
                    ...
                    if (motivo2 == "") {
                        ...
                        document.getElementById('conferma_scarta').href = "OperazioniRegional?type=17&motivo=" + encodeURIComponent(motivo2) + "&idregistri=" + $('#id_s').val() + '&tipo=' + $('#tipo_s').val() + "&pagina=regT_anomalieDT"
                                + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>";
                    }
                } else {
                    document.getElementById('conferma_scarta').href = "OperazioniRegional?type=17&motivo=" + encodeURIComponent(motivo1) + "&idregistri=" + $('#id_s').val() + '&tipo=' + $('#tipo_s').val() + "&pagina=regT_anomalieDT"
                            + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>";
                }
            ...
            function submitScarto2() {
                ...
                if (motivo12 == null || motivo12 == "..." || motivo12 == "") {
                    ...
                    if (motivo22 == "") {
                        ...
                        document.getElementById('conferma_scarta2').href = "OperazioniRegional?type=18&motivo=" + encodeURIComponent(motivo22) + "&idregistri=" + $('#id_s2').val() + '&tipo=' + $('#tipo_s2').val() + '&ore=' + ore + "&pagina=regT_anomalieDT"
                                + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>";
                    }
                } else {
                    document.getElementById('conferma_scarta2').href = "OperazioniRegional?type=18&motivo=" + encodeURIComponent(motivo12) + "&idregistri=" + $('#id_s2').val() + '&tipo=' + $('#tipo_s2').val() + '&ore=' + ore + "&pagina=regT_anomalieDT"
                            + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>";
                }
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-blue">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        <h4 class="modal-title">Accetta Registro</h4>
                    </div>
                    <div class="modal-body" id="largetext">                       
                        <label class="text"> Sicuro di voler accettare questo registro? </label>
                    </div>
                    <div class="modal-footer">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content ">
                    ...
                    <div class="modal-body">                       
                        ...
                        <div id="div_ore" class="col-md-4">
                            <label class="text">Ore Effettuate dal Destinatario </label><label style="color: red"> &nbsp;*</label>
                            <input class="form-control" type="number" step="1" min="0" max="200" id="id_ore" name="id_ore" >
                        </div>
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu_regional/menu_tirocinanteDT.jsp"%>
            <!-- END MENU -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->                    
                    <h3 class="page-title" style="color:#2D5F8B"><strong> ACCOMPAGNAMENTO AL TIROCINIO </strong>  <small style="color:#2D5F8B"> ANOMALIE DESTINATARI </small> </h3>    
                    ...
                    <div class="portlet box red-flamingo">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="regT_anomalieDT.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="regT_anomalieDT.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                            ...
                            <div class="portlet box blue-soft">
                                ...
                                <div class="portlet-body">                                  
                                    <table class="table table-bordered" id="sample_0" width="100%">
                                        <thead>
                                            <tr>
                                                <th width="11%">Azione</th>
                                                <th width="11%">Motivo</th>
                                                <th width="10%">Destinatario</th>
                                                <th width="10%">Codice Fiscale</th>
                                                <th width="15%">Ente</th>
                                                <th width="7%">Mese</th>
                                                <th width="8%">Inizio/Fine</th>
                                                <th width="5%">Durata</th>
                                                <th width="15%">Documenti</th>
                                                <th width="8%">Data Domanda Rimborso</th>
                                            </tr>
                                        </thead>
                                        <tbody>                                       
                                        </tbody>
                                ...
                                jQuery(document).ready(function () {
                                    var dt2 = function () {
                                        ...
                                        g.dataTable({
                                            ...
                                            processing: true,
                                            ajax: {
                                                url: "QueryRegional?type=25&politica=C06&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>",
                                                dataSrc: "aaData",
                                                type: "GET"
                                            },
