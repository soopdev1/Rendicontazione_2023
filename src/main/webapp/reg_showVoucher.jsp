...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "reg_showVoucher.jsp")) {
    ...
    <body class="page-full-width page-content-white">
        ...
        <script type="text/javascript">
                                    ...
                                    language: {aria: {},
                                            ...
                                            processing: true,
                                            ajax: {
                                            url: "QueryRegional?type=29&idrimborso=<%=request.getParameter("idrimborso")%>&politica=<%=request.getParameter("politica")%>&esi=<%=esiti%>",
                                                    dataSrc: "aaData",
                                                    type: "GET"
                                            },
