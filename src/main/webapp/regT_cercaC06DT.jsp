...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "regT_cercaC06DT.jsp")) {
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            var ente = $("#ente").val();
            var err = false;
            if (nome == "" && cognome == "" && cf == "" && from == "" && to == "" && (ente == null || ente == "...")) {
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu_regional/menu_TirociniDT.jsp"%>
            <!-- END MENU -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"><strong> ACCOMPAGNAMENTO AL TIROCINIO</strong><small> CERCA TIROCINIO</small></h3>
                    ...
                    <div class="portlet box red-flamingo">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="regT_cercaM5.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="regT_cercaC06DT.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="portlet box blue-soft">
                                ...
                                <div class="portlet-body">
                                    <table width="100%" class="table table-striped table-bordered table-hover order-column table-scrollable" id="sample_0"> 
                                        ...
                                        <th><center>Ente Promotore </center> </th>
        ...
        <script type="text/javascript">
            ...
            <%if (true) {%>
                                ajax: {
                                url: "QueryRegional?type=39&politica=C06&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>&from=<%=from%>&to=<%=to%>&ente=<%=ente%>",
                                        dataSrc: "aaData",
                                        type: "GET"
                                },
            <%}%>
