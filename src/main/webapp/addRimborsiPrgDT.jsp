...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "addRimborsiPrgDT.jsp")) {
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            var to = $("#to").val();
            var err = false;
            if (nome == "" && cognome == "" && cf == "" && from == "" && to == "" && (politica == null || politica == "..." || politica == "")) {
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <form action="OperazioniEnte?type=17" method="post" id="form2" accept-charset="ISO-8859-1" style="display: none">
            <input type="hidden" name="page" value="addRimborsiPrgDT.jsp">
            ...
            <input type="hidden" name="politica" value="C06">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"><strong>ACCOMPAGNAMENTO AL TIROCINIO</strong><small> RICHIEDI RIMBORSO</small></h3>
                    ...
                    <div class="portlet box blue-soft">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="addRimborsiPrgDT.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="addRimborsiPrgDT.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="portlet box yellow-gold">
                        <div class="portlet-title">
                            <div class="caption">  
                                ...
                                <span class="caption-subject font-white bold ">IMPORTANTE: verranno mostrati solo i progetti formativi con il numero di ore svolte pari o superiore al 70% del totale previsto</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue-hoki">
                                ...
                                <div class="portlet-body">
                                    <table width="100%" class="table table-striped table-bordered table-hover order-column" id="sample_0"> 
                                        <thead>
                                            <tr>
                                        ...
                                        <th><center>Data Inizio </center> </th>
                                        <th><center>Data Fine</center> </th>
                                        <th><center>Cod. Politica</center> </th>
                                        <th><center>Tot. Ore Progetto</center> </th>
        ...
        <script type="text/javascript">
            ...
            <%if (true) {%>
                                ajax: {
                                url: "QueryEnte?type=12&stato=C&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>&from=<%=from%>&to=<%=to%>&politica=C06",
                                        dataSrc: "aaData",
                                        type: "GET"
                                },
            <%}%>
...
//                                                        scrollY: 'true',
        ...
        <script type="text/javascript">
                    ...
                    location.href = "OperazioniGeneral?type=6&path=<%=request.getParameter("path")%>";
                    });
        </script>
        <%}%>
