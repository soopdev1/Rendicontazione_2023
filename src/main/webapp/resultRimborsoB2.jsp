...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "resultRimborsoB2.jsp")) {
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"><strong>B2</strong><small> ESITI POSITIVI</small></h3>
                    ...
                    <div class="portlet box blue-soft">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="resultRimborsoB2.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            <a href="resultRimborsoB2.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                ...
                                jQuery(document).ready(function () {
                                    var dt2 = function () {
                                        ...
                                        g.dataTable({
                                            ...
                                            processing: true,
                                            ajax: {
                                                url: "QueryEnte?type=26&stato=P&politica=B2&protocollo=<%=protocollo%>&from_up=<%=from_up%>&to_up=<%=to_up%>&from_mod=<%=from_mod%>&to_mod=<%=to_mod%>",
                                                dataSrc: "aaData",
                                                type: "GET"
                                            },
