...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "upDocContratto.jsp")) {
            ...
            Politica pol = Action.getPoliticaByID(id);
            pol.setContratto(Action.getContrattoById(pol.getId()));
%>
<html>
    <head>
        <meta charset="utf-8">
...
//                                    }
                            ...
                            <div class="portlet-body form">
                                <form class="form-horizontal" action="<%="OperazioniEnte?type=9"%>" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group portlet light bordered">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-4" id="div_m5">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        <label>Modulo M5</label><label type="text" style="color: red" >*</label>
                                                        <div class="input-group input-large">
                                                            <div class="form-control uneditable-input input-fixed input-medium" data-trigger="fileinput">
                                                                <i class="fa fa-file fileinput-exists"></i>&nbsp;
                                                                <span class="fileinput-filename"> </span>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-3" id="div_inizio" style="padding-right: 0px;">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="inizio" name="inizio" autocomplete="off" readonly value="<%=Utility.formatStringtoStringDate(pol.getDataavvio(), "yyyy-MM-dd", "dd/MM/yyyy")%>" onchange="return checkDate();">
                                                ...
                                                <%  String data = "";
                                                    String check = "";
                                                    if (pol.getDatafine() == null && pol.getNew_datafine() == null) {
                                                        check = "checked";
                                                    } else {

                                                        if (pol.getNew_datafine() != null) {
                                                            data = Utility.formatStringtoStringDate(pol.getNew_datafine(), "yyyy-MM-dd", "dd/MM/yyyy");
                                                        } else {
                                                            data = Utility.formatStringtoStringDate(pol.getDatafine(), "yyyy-MM-dd", "dd/MM/yyyy");
                                                        }
                                                    }%>
                                                <div class="col-md-1" id="div_indetrminato">
                                                    <label>Indeterminato</label><br/>
                                                    <input type="checkbox" readonly <%=check%> class="make-switch form-control" name="indeterminato" id="indeterminato" onchange="return mostradatafine();" data-on-text="<i class='fa fa-check'></i>" data-off-text="<i class='fa fa-times'></i>" >
                                                </div>
                                                <div class="col-md-3" id="div_fine">
                                                    <label>Data Fine Contratto</label>
                                                    <div class="input-group" data-date-format="dd/mm/yyyy">
                                                        <input type="text" class="form-control" id="fine" name="fine" autocomplete="off" readonly value="<%=data%>" onchange="return checkDate();">
                                                        <span class="input-group-btn">
                                                            <button class="btn default" type="button">
                                                                <i class="fa fa-calendar"></i>
                                                            </button>
                            ...
                            <div class="portlet-body form">
                                <form class="form-horizontal" action="<%="OperazioniEnte?type=9"%>" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm2();" enctype="multipart/form-data">
                                    <input type="hidden" value="<%=id%>" name="id">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="portlet light bordered">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-1" id="div_indetrminato">
                                                    <label>Indeterminato</label><br/>
                                                    <input type="checkbox" disabled <%=check%> class="make-switch form-control" name="indeterminato" id="indeterminato" onchange="return mostradatafine();" data-on-text="<i class='fa fa-check'></i>" data-off-text="<i class='fa fa-times'></i>" >
                                                </div>
                                                <div class="col-md-3" id="div_fine">
