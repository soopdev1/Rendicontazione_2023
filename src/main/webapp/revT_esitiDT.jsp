...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "revT_esitiDT.jsp")) {
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function ctrlForm() {
                ...
                var cf = $("#cf").val();
                var err = false;
                if ((ente == null || ente == "...") && from == "" && to == "" && cf == "" && nome == "" && cognome == "" && politica == "" && (esito == null || esito == "...")) {
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->                    
                    <h3 class="page-title" style="color:#2D5F8B"><strong> ACCOMPAGNAMENTO AL TIROCINIO </strong>  <small style="color:#2D5F8B"> ESITI TIROCINI </small> </h3>    
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <div class="portlet box purple-seance">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="revT_esitiDT.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3" id="div_esito">
                                            <label>Esito</label>
                                            <select class="form-control select2-allow-clear" id="esito" name="esito">
                                                <option value="...">...</option>
                                                <%if (esito.equals("P")) {%>
                                                <option selected value="P">Pagato</option>
                                                <%} else {%>
                                                <option value="P">Pagato</option>
                                                <%}%>
                                                <%if (esito.equals("K")) {%>
                                                <option selected value="K">Rigettato</option>
                                                <%} else {%>
                                                <option value="K">Rigettato</option>
                                                <%}%>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="revT_esitiDT.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                    ...
                                    <table class="table table-bordered" id="sample_0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="6%">Durata</th>
                                                <th width="9%">Data Domanda Rimborso</th>
                                                <th width="24%">Motivo Rigetto</th>
                                                <th width="9%">Totale Erogato</th>
                                            </tr>
                                        </thead>
                                        <tbody>                                       
                                        </tbody>
                                ...
                                jQuery(document).ready(function () {
                                    var dt2 = function () {
                                        ...
                                        g.dataTable({
                                            ...
                                            processing: true,
                                            ajax: {
                                                url: "QueryRevisore?type=19&politica=C06&esito=<%=esito%>&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>",
                                                dataSrc: "aaData",
                                                type: "GET"
                                            },
