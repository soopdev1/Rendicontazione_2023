...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "showPrgRimborsoDt.jsp")) {
                            ...
                            jQuery(document).ready(function () {
                                var dt2 = function () {
                                    ...
                                    g.dataTable({
                                        ...
                                        processing: true,
                                        ajax: {
                                            url: "QueryEnte?type=14&idrimborso=<%=request.getParameter("id")%>",
                                            dataSrc: "aaData",
                                            type: "GET"
                                        },
            ...
            jQuery(document).ready(function () {
                var dt2 = function () {
                    ...
                    g.dataTable({
                        ...
                        processing: true,
                        ajax: {
                            url: "QueryEnte?type=15&idrimborso=<%=request.getParameter("id")%>",
                            dataSrc: "aaData",
                            type: "GET"
                        },
                        drawCallback: function (settings, json) {
