...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "regT_liquidazioneDT.jsp")) {
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-outline blue large" id="confirmdisactive" onclick="return creaDomanda()"><i class="fa fa-upload"></i> Carica</a> 
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title" style="color:#2D5F8B"><strong> ACCOMPAGNAMENTO AL TIROCINIO </strong><small style="color:#2D5F8B"> LIQUIDAZIONE DESTINATARIO</small></h3>
                    ...
                    <div class="portlet box red-flamingo">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="regT_liquidazioneDT.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="regT_liquidazioneDT.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                    ...
                    <form class="form-horizontal" action="OperazioniRegional?type=19&page=regT_liquidazioneDT.jsp" method="post" name="form2" id="form2" accept-charset="ISO-8859-1" style="display: none;" >  
                                ...
                                jQuery(document).ready(function () {
                                    var dt2 = function () {
                                        ...
                                        g.dataTable({
                                            ...
                                            ajax: {
                                                url: "QueryRegional?type=26&politica=C06&ente=<%=ente%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>&from=<%=from%>&to=<%=to%>",
                                                dataSrc: "aaData",
                                                type: "GET"
                                            },
...
//                                                        {extend: "colvis", className: "btn white btn-outline", text: "Columns"},
                                                ...
                                                {className: "btn white bg-green-jungle btn-outline", text: "<i class='fa fa-refresh' style='color:white; font-size: 12px;'><font color='white' face='verdana'> Crea file INPS</font></i>",
