...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "show_politichelavoratore.jsp")) {
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function showStatoRimborso(domanda_rimborso, cod) {
                $.get('OperazioniRegional?type=26&cod=' + cod + '&idrimborso=' + domanda_rimborso, function (response) {
                    if (response == "S") {
            ...
            function showEnte(cf) {
                $.get('OperazioniRegional?type=30&cf=' + cf, function (response) {
                                        ...
                                        jQuery(document).ready(function () {
                                            var dt2 = function () {
                                                ...
                                                g.dataTable({
                                                    ...
                                                    processing: true,
                                                    ajax: {
                                                        url: "QueryRegional?type=37&idlav=<%=request.getParameter("idlav")%>",
                                                        dataSrc: "aaData",
                                                        type: "GET"
                                                    },
