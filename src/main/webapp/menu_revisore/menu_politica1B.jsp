...
<%
    ...
    String liq = "";
    String esiti = "";
    if (pageName.equals("rev_liquidazione1B.jsp")) {
        liq = "active open";
    } else if (pageName.equals("rev_esiti1B.jsp")) {
        esiti = "active open";
    }
%>
                    ...
                    <li class="nav-item active open">
                        ...
                        <ul class="sub-menu">
                            <li class="nav-item start <%=liq%>">
                                <a href="rev_liquidazione1B.jsp" class="nav-link nav-toggle">
                                    <i class="fa fa-money"></i>
                                    <span class="title"> LiquidazioneAmmiss. Indennità</span>       
                                    <span class="badge bg-blue-chambray"></span>
                                </a>   
                            </li>
                            <li class="nav-item start <%=esiti%>">
                                <a href="rev_esiti1B.jsp" class="nav-link nav-toggle">
