...
<%
    ...
    String liq = "";
    String esiti = "";
    if (pageName.equals("rev_liquidazioneC2DT.jsp")) {
        liq = "active open";
    }else if (pageName.equals("rev_esitiC2DT.jsp")) {
        esiti = "active open";
    }
%>
                    ...
                    <li class="nav-item active open">
                        ...
                        <ul class="sub-menu">
                            <li class="nav-item start <%=liq%>">
                                <a href="rev_liquidazioneC2DT.jsp" class="nav-link nav-toggle">
                             ...
                             <li class="nav-item start <%=esiti%>">
                                <a href="rev_esitiC2DT.jsp" class="nav-link nav-toggle">
