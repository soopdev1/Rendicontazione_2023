...
<%
    ...
    String liq = "";
    String esiti = "";
    if (pageName.equals("rev_liquidazioneB2DT.jsp")) {
        liq = "active open";
    } else if (pageName.equals("rev_esitiB2DT.jsp")) {
        esiti = "active open";
    }
%>
                    ...
                    <li class="nav-item active open">
                        ...
                        <ul class="sub-menu">
                            <li class="nav-item start <%=liq%>">
                                <a href="rev_liquidazioneB2DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=esiti%>">
                                <a href="rev_esitiB2DT.jsp" class="nav-link nav-toggle">
