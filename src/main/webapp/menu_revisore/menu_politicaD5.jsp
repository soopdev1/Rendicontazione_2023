...
<%
    ...
    String liq = "";
    String esiti = "";
    if (pageName.equals("rev_liquidazioneD5DT.jsp")) {
        liq = "active open";
    }else if(pageName.equals("rev_esitiD5DT.jsp")){
        esiti = "active open";
    }
%>
                    ...
                    <li class="nav-item active open">
                        ...
                        <ul class="sub-menu">
                            <li class="nav-item start <%=liq%>">
                                <a href="rev_liquidazioneD5DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=esiti%>">
                                <a href="rev_esitiD5DT.jsp" class="nav-link nav-toggle">
