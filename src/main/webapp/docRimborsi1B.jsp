...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "docRimborsi1B.jsp")) {
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"><strong> 1B </strong><small> CARICA DOCUMENTI</small></h3>
                    ...
                    <div class="portlet box blue-soft">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="docRimborsi1B.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="docRimborsi1B.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <script type="text/javascript">
                                jQuery(document).ready(function () {
                                    var dt2 = function () {
                                        ...
                                        ajax: {
                                        url: "QueryEnte?type=3&stato=I&politica=A01&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>&from=<%=from%>&to=<%=to%>",
                                                dataSrc: "aaData",
                                                type: "GET"
                                        },
                                         <%}%>
