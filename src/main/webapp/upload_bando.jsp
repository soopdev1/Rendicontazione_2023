...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "upload_bando.jsp")) {
        ...
        function ctrlForm() {
            ...
            if (nomefile != "") {
                if (estensione != ".pdf" || estensione != ".PDF") {
                    ...
                    $("#div_file").attr("class", "col-md-4 has-success");
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper" >
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title" style="color:#2D5F8B"><strong> BANDI </strong><small style="color:#2D5F8B"> CARICA</small> </h3>  
                    ...
                    <div class="alert bg-red-thunderbird  alert-dismissible " style="text-align: center;color: white">
                        ...
                        <span><strong>Errore, il bando non è stato caricato! Riprovare</strong></span>            
                    </div>
                    <%} else if (esitoins.equals("OK")) {%> 
                    <br>
                    <div class="alert bg-green-jungle alert-dismissible " style="text-align: center;color: white">
                        <button type="button" class="close" data-close="alert"></button>
                        <span><strong>Bando caricato con successo!</strong></span>
                    </div>
                    <%}%>
                    <div class="portlet box blue-soft">
                        <div class="portlet-title">
                            <div class="caption">  
                                ...
                                <span class="caption-subject font-white bold ">Carica Bando</span>
                            </div>
                        </div>

                        <div class="portlet-body form">
                            <form class="form-horizontal" action="<%="OperazioniRegional?type=1"%>" method="post" enctype="multipart/form-data" onsubmit="return ctrlForm();">
                                <div class="form-body">
                                    <div class="form-group">

                                        <div class="col-md-3" id="div_tipo">
                                            <label>Tipologia</label><label type="text" style="color: red" >*</label>
                                        ...
                                        <div class="col-md-4" id="div_titolo">
                                            <label>Programma</label><label type="text" style="color: red" >*</label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-2" id="div_budget" style=" padding-right: 0px; width: 16%;">
                                            ...
                                            <div class="input-group"> 
                                                ...
                                                <input class="form-control" style="direction: rtl;" type="number" id="budget" name="budget" step="1" placeholder="0000"></div>
                                        </div>
                                        ...
                                        <div class="col-md-3" id="div_decreto">
                                            ...
                                            <input class="form-control" type="text" id="decreto" name="decreto" maxlength="45">
                                        </div>
                                        <div class="col-md-4" id="div_file" >
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <label>File</label><label type="text" style="color: red" >&nbsp;</label>
                                                <div class="input-group input-large" >
                                                    ...
                                                    <span class="input-group-addon btn default btn-file">
                                                        ...
                                                        <input type="file" id="file" accept="application/pdf" name="file" onchange="ctrlFile('file');"></span>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-3" id="div_datainizio">
                                            ...
                                            <div class="input-group input-medium date date-picker" style="width: 100%!important;" data-date-format="dd/mm/yyyy" >
                                                <input type="text" class="form-control" id="datainizio" name="datainizio" autocomplete="off">
                                    ...
                                    <div class="form-group ">       
                                        <div class="col-md-3" id="div_datafine" style="display: block;">
                                            ...
                                            <div class="input-group input-medium date date-picker" style="width: 100%!important;" data-date-format="dd/mm/yyyy" >
                                                <input type="text" class="form-control" id="datafine" name="datafine" autocomplete="off">
                                                <span class="input-group-btn">
                                                    <button class="btn default" type="button">
                                                        <i class="fa fa-calendar"></i>
                                                    </button>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4"> 
                                            <button type="submit" class="btn blue btn-outline"><i class="fa fa-upload"></i> Conferma</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
