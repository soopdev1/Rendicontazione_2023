...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "rev_showPoliticheRimborso.jsp")) {
            ...
            //    tipo = "M3";
            //} else if (politica.equals("B05")) {
            //    tipo = "1C";
            //}
            String prot = request.getParameter("protocollo");
            if (prot == null) {
                prot = "-";
            }
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            document.getElementById('confirmdisactive').href = "OperazioniRevisore?type=4&idpolitica=" + id + "&idrimborso=" + id2;
            }
            ...
            document.getElementById('conferma_scarta').href = "OperazioniRevisore?type=3&motivo=" + encodeURIComponent(motivo2) + "&idpolitica=" + $('#id_s').val() + "&idrimborso=" + $('#id_r').val() + "&protocollo=<%=prot%>&politica=<%=pol%>";
            }
            } else {
            document.getElementById('conferma_scarta').href = "OperazioniRevisore?type=3&motivo=" + encodeURIComponent(motivo) + "&idpolitica=" + $('#id_s').val() + "&idrimborso=" + $('#id_r').val() + "&protocollo=<%=prot%>&politica=<%=pol%>";
            }
            ...
            document.getElementById('conferma_scarta1').href = "OperazioniRevisore?type=4&motivo=" + encodeURIComponent(motivo12) + "&idpolitica=" + $('#id_s1').val() + "&idrimborso=" + $('#id_r1').val() + "&protocollo=<%=prot%>&politica=<%=pol%>";
            }
            } else {
            document.getElementById('conferma_scarta1').href = "OperazioniRevisore?type=4&motivo=" + encodeURIComponent(motivo1) + "&idpolitica=" + $('#id_s1').val() + "&idrimborso=" + $('#id_r1').val() + "&protocollo=<%=prot%>&politica=<%=pol%>";
            }
    ...
    <body class="page-full-width page-content-white">
        ...
        <div class="modal fade bs-modal-lg" id="scartamodal1" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content ">
                    ...
                    <div class="modal-body">                       
                        <label class="text">Specificare motivazione scarto </label><label style="color: red"> &nbsp;*</label>
                        <input type="hidden" id="id_s1">
                        <input type="hidden" id="id_r1">
                        <div id="div_motivo1">
            ...
            <div class="page-content-wrapper" >
                ...
                <div class="page-content">                    
                    ...
                    <div class="row">
                        ...
                        <div class="alert bg-green-jungle alert-dismissible " style="text-align: center;color: white">
                            <button type="button" class="close" data-close="alert"></button>
                            <span><strong>Singolo rimborso rigettato con successo! Rigettato l'intero rimborso!</strong></span>
                        </div>
                        <%}%>
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject font-blue bold">
                                    <h3 class="page-title"><strong> POLITICHE </strong><small> RIMBORSO PROT. <%=prot%></small> </h3>                                    
                                </span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="portlet-body">
                                        <table width="100%" class="table table-responsive table-bordered table-scrollable dataTable no-footerr" id="sample_0"> 
                                            ...
                                            <tfoot hidden>
                                                <tr>
                                                    <%if (esiti.equals("KO")) {%>
                                                    <th><input type="text" class="form-control tf1" name="dest1" placeholder="..." disabled=""></th>
                                                        <%}%>
                                ...
                                <div class="portlet box red-soft">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <a class="fa fa-exclamation white tooltips" style="cursor: default;color: white;"></a>
                                            <span class="caption-subject font-white bold ">Rigettati |</span>
                                            <a class="fa fa-ban white tooltips" style="cursor: default;color: white;"></a>
                                            <span class="caption-subject font-white bold "> Scartati</span>
                                        </div>
                                        <div class="tools">
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                                        <table width="100%" class="table table-responsive table-bordered table-scrollable dataTable no-footerr" id="sample_1"> 
                                            <thead>
                                                <tr>
                                            ...
                                            <th><center>Codice Fiscale </center> </th>
                                            <th><center>Tutor </center> </th>
                                                <%if (request.getParameter("politica").equals("B05")) {%>
                                            <th><center>Durata </center> </th>
                                                <%}%>                
                                            ...
                                            <tfoot hidden>
                                                <tr>
                                                    <th><input type="text" class="form-control tf2" name="dest1" placeholder="..."></th>
                                                    <th><input type="text" class="form-control tf2" name="dest1" placeholder="..."></th>
                                                    <th><input type="text" class="form-control tf2" name="dest1" placeholder="..."></th>
                                                    <th><input type="text" class="form-control tf2" name="dest1" placeholder="..."></th>
                                                    <th><input type="text" class="form-control tf2" name="dest1" placeholder="..."></th>
        ...
        <script type="text/javascript">
                                    ...
                                    language: {aria: {},
                                            ...
                                            processing: true,
                                            ajax: {
                                            url: "QueryRevisore?type=2&politica=<%=request.getParameter("politica")%>&idrimborso=<%=request.getParameter("id")%>&esi=<%=esiti%>",
                                                    dataSrc: "aaData",
                                                    type: "GET"
                                            },
...
//                                            scrollY: 'true',
        ...
        <script type="text/javascript">
            ...
            language: {aria: {},
                    ...
                    processing: true,
                    ajax: {
                    url: "QueryRevisore?type=4&idrimborso=<%=request.getParameter("id")%>&politica=<%=request.getParameter("politica")%>",
                            dataSrc: "aaData",
                            type: "GET"
                    },
                    drawCallback: function (settings, json) {
            ...
            $(".tf2").keyup(function () {
            g1.fnFilter(this.value, g1.oApi._fnVisibleToColumnIndex(
                    g1.fnSettings(), $(".tf2").index(this)));
            });
            $(".tf2").each(function (i) {
            this.initVal = this.value;
            });
