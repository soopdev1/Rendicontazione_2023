...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "showPoliticheRimborso.jsp")) {
    ...
    <body class="page-full-width page-content-white">
            ...
            <div class="page-content-wrapper" >
                ...
                <div class="page-content">                    
                    ...
                    <div class="row">
                        ...
                        <%if (request.getParameter("stato").equals("P")) {%>
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject font-blue bold">
                                    <h3 class="page-title"><strong> POLITICHE </strong><small> RIMBORSO PROT. <%=(String) request.getParameter("protocollo")%></small> </h3>                                    
                                </span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portlet box green-jungle">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <a class="fa fa-check white tooltips" style="cursor: default;color: white;"></a>
                                            <span class="caption-subject font-white bold ">Accettati</span>
                                        </div>
                                        <div class="tools">
                                        </div>
                                    </div>
                        ...
                        <%} else if (request.getParameter("stato").equals("S")) {%>
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                                <div class="portlet box blue-hoki">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-white bold ">Elenco</span>
                                        </div>
                                        <div class="tools">
                                        </div>
                                    </div>
        ...
        <script type="text/javascript">
                            ...
                            language: {aria: {},
                                    ...
                                    processing: true,
                                    ajax: {
                                    url: "QueryEnte?type=5&politica=<%=request.getParameter("politica")%>&idrimborso=<%=request.getParameter("id")%>",
                                            dataSrc: "aaData",
                                            type: "GET"
                                    },
        ...
        <script type="text/javascript">
            ...
            language: {aria: {},
                    ...
                    processing: true,
                    ajax: {
                    url: "QueryEnte?type=7&idrimborso=<%=request.getParameter("id")%>&politica=<%=request.getParameter("politica")%>",
                            dataSrc: "aaData",
                            type: "GET"
                    },
                    drawCallback: function (settings, json) {
