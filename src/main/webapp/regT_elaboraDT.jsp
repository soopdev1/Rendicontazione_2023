...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "regT_elaboraDT.jsp")) {
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function setAccettaID(id) {
                document.getElementById('confirmactive').href = 'OperazioniRegional?type=16&idregistri=' + id + '&tipo=' + document.getElementById(id + '_pol').value + "&pagina=regT_elaboraDT"
            ...
            function submitScarto() {
                ...
                if (motivo1 == null || motivo1 == "..." || motivo1 == "") {
                    ...
                    if (motivo2 == "") {
                        ...
                        document.getElementById('conferma_scarta').href = "OperazioniRegional?type=17&motivo=" + encodeURIComponent(motivo2) + "&idregistri=" + $('#id_s').val() + '&tipo=' + $('#tipo_s').val() + "&pagina=regT_elaboraDT"
                                + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>";
                    }
                } else {
                    document.getElementById('conferma_scarta').href = "OperazioniRegional?type=17&motivo=" + encodeURIComponent(motivo1) + "&idregistri=" + $('#id_s').val() + '&tipo=' + $('#tipo_s').val() + "&pagina=regT_elaboraDT"
                            + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>";
                }
            ...
            function submitScarto2() {
                ...
                if (motivo12 == null || motivo12 == "..." || motivo12 == "") {
                    ...
                    if (motivo22 == "") {
                        ...
                        document.getElementById('conferma_scarta2').href = "OperazioniRegional?type=18&motivo=" + encodeURIComponent(motivo22) + "&idregistri=" + $('#id_s2').val() + '&tipo=' + $('#tipo_s2').val() + '&ore=' + ore + "&pagina=regT_elaboraDT"
                                + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>";
                    }
                } else {
                    document.getElementById('conferma_scarta2').href = "OperazioniRegional?type=18&motivo=" + encodeURIComponent(motivo12) + "&idregistri=" + $('#id_s2').val() + '&tipo=' + $('#tipo_s2').val() + '&ore=' + ore + "&pagina=regT_elaboraDT"
                            + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>";
                }
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->                    
                    <h3 class="page-title" style="color:#2D5F8B"><strong> ACCOMPAGNAMENTO AL TIROCINIO </strong>  <small style="color:#2D5F8B"> GESTIONE DESTINATARIO </small> </h3>    
                    ...
                    <div class="portlet box red-flamingo">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="regT_elaboraDT.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="regT_elaboraDT.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                ...
                                jQuery(document).ready(function () {
                                    var dt2 = function () {
                                        ...
                                        g.dataTable({
                                            ...
                                            processing: true,
                                            ajax: {
                                                url: "QueryRegional?type=24&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>&politica=C06",
                                                dataSrc: "aaData",
                                                type: "GET"
                                            },
            ...
            <script type="text/javascript">
                function showPrg(id) {
                    $.get('OperazioniRegional?type=28&id=' + id, function (response) {
                        if (response != "") {
