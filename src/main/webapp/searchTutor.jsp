            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-warning large " id="confirmdisactive" onclick="">Conferma</a> 
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"><strong> TUTOR </strong><small> GESTIONE</small> </h3>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue-soft">
                                ...
                                <div class="portlet-body">
                                    <table width="100%" class="table table-hover table-responsive table-bordered table-condensed server-sort" id="sample_0"> 
                                        <thead>
                                            <tr>
                                        ...
                                        <th><center>Scadenza Documento<br> Riconoscimento </center></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
