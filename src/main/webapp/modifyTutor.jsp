                ...
                <div class="page-content">                    
                    ...
                    <div class="row">
                        ...
                        <div class="alert bg-green-jungle alert-dismissible " style="text-align: center;color: white">
                            <button type="button" class="close" data-close="alert"></button>
                            <span><strong>Tutor aggiornato con successo!</strong></span>
                        </div>
                            ...
                            <div class="portlet-title">
                                <div class="caption">
                                    <span class="caption-subject font-blue bold">
                                        <h3 class="page-title"><strong> TUTOR: </strong><small> <%=t.getNome().toUpperCase()%> <%=t.getCognome().toUpperCase()%></small> </h3>
                                    </span>
                                </div>
                            </div>
                            <div class="portlet-body form">
                                <form class="form-horizontal" action="<%="OperazioniEnte?type=33"%>" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();" enctype="multipart/form-data">
                                    <input type="hidden" value="<%=t.getId()%>" name="idtutor">
                                    <div class="form-body">
                                        <div class="form-group">
                                            <div class="col-md-3" id="div_name">
                                                <label>Nome</label><label type="text" style="color: red" >*</label>
                                                <input type="text" class="form-control" value="<%=t.getNome()%>" id="nome" name="nome">
                                            </div>
                                            <div class="col-md-3" id="div_surname">
                                                <label>Cognome</label><label type="text" style="color: red" >*</label>
                                                <input type="text" class="form-control" value="<%=t.getCognome()%>" id="cognome" name="cognome">
                                            </div>
                                            <div class="col-md-3" id="div_cf">
                                                <label>Codice Fiscale</label><label type="text" style="color: red" >*</label>
                                                <input type="text" class="form-control" value="<%=t.getCf()%>" id="cf" name="cf" maxlength="16" onchange="return checkCF();">
                                                <div class="" >
                                            ...
                                            <div class="col-md-3" id="div_ruolo">
                                                ...
                                                <select class="form-control select2-allow-clear" id="ruolo" name="ruolo">
                                                    <option value="...">...</option>
                                                    <%for (String[] s : ruoli) {%>
                                                    <%if (s[0].equals(String.valueOf(t.getRuolo()))) {%>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-3" id="div_email">
                                                <label>Email</label>
                                                <input type="email" class="form-control" value="<%=(t.getEmail().equals("-") ? "" : t.getEmail())%>" id="email" name="email">
                                            </div>
                                            <div class="col-md-3" id="div_tel">
                                                <label>Telefono</label>
                                                <input type="text" class="form-control" id="telefono" value="<%=(t.getTelefono().equals("-") ? "" : t.getTelefono())%>" name="telefono" onkeypress="return isNumber(event);" maxlength="10">
                                            </div>
                                        </div>
                                        <br><label type="text" style="color: red" >* Campo Obbligatorio</label><br><br>
                                        <div class="form-group">
                                            <div class="col-md-4"> 
                                                <button type="submit" class="btn blue-soft btn-outline"><i class="fa fa-pencil"></i> Modifica</button>                                            
                                            </div>
                                        </div>
                                    </div>
                                </form>
