...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "reg_showTirocinantiRimborso.jsp")) {
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            document.getElementById('conferma_scarta').href = "OperazioniRegional?type=7&motivo=" + encodeURIComponent(motivo2) + "&idpolitica=" + $('#id_s').val() + "&idrimborso=" + $('#id_r').val() + "&pol=<%=request.getParameter("politica")%>";
            }
            } else {
            document.getElementById('conferma_scarta').href = "OperazioniRegional?type=7&motivo=" + encodeURIComponent(motivo) + "&idpolitica=" + $('#id_s').val() + "&idrimborso=" + $('#id_r').val() + "&pol=<%=request.getParameter("politica")%>";
            }
            ...
            document.getElementById('conferma_scarta1').href = "OperazioniRegional?type=8&motivo=" + encodeURIComponent(motivo12) + "&idpolitica=" + $('#id_s').val() + "&idrimborso=" + $('#id_r').val() + "&pol=<%=request.getParameter("politica")%>";
            }
            } else {
            document.getElementById('conferma_scarta1').href = "OperazioniRegional?type=8&motivo=" + encodeURIComponent(motivo1) + "&idpolitica=" + $('#id_s').val() + "&idrimborso=" + $('#id_r').val() + "&pol=<%=request.getParameter("politica")%>";
            }
    ...
    <body class="page-full-width page-content-white">
                            ...
                            <div class="portlet-title">
                                <div class="caption">
                                    <span class="caption-subject font-blue bold">
                                        <h3 class="page-title"><strong> POLITICHE </strong><small> RIMBORSI DESTINATARI</small> </h3>                                    
                                    </span>
                                </div>
                            </div>
                            <div class="row">
                                            ...
                                            <table width="100%" class="table table-responsive table-bordered table-scrollable dataTable no-footerr" id="sample_0"> 
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <%}%>
                                                <th width="15%"><center>Comunicazioni Obbligatorie</center></th>
        ...
        <script type="text/javascript">
                                    ...
                                    language: {aria: {},
                                            ...
                                            processing: true,
                                            ajax: {
                                            url: "QueryRegional?type=6&idrimborso=<%=request.getParameter("idrimborso")%>&politica=<%=request.getParameter("politica")%>&esi=<%=esiti%>",
                                                    dataSrc: "aaData",
                                                    type: "GET"
                                            },
