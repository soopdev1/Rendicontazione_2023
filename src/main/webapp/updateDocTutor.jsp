...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "updateDocTutor.jsp")) {
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function ctrlForm() {
                ...
                if (scadenza == "") {
                    $("#div_scadenza").attr("class", "col-md-4 has-error");
                    err = true;
                } else {
                    $("#div_scadenza").attr("class", "col-md-4 has-success");
                }
                if (!ctrlFile('file')) {
                    ...
                    <div class="row">
                        ...
                        <div class="portlet light bordered ">
                            ...
                            <div class="portlet-body form">
                                <form class="form-horizontal" action="<%="OperazioniEnte?type=3"%>" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();" enctype="multipart/form-data">
                                    <input type="hidden" value="<%=t.getNome()%>" name="nome">
                                    <input type="hidden" value="<%=t.getCognome()%>" name="cognome">
                                    <input type="hidden" value="<%=t.getDocumento()%>" name="doc">
                                    <input type="hidden" value="<%=t.getId()%>" name="idtutor">
                                    <div class="form-body">
                                        <div class="form-group">
                                            <div class="col-md-4" id="div_scadenza">
