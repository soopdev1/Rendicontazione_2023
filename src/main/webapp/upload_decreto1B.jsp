...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "upload_decreto1B.jsp")) {
            response.sendRedirect("page_403.html");
        } else {
            //Etichette et = new Etichette("IT");
            String pol = request.getParameter("pol");
            String id = request.getParameter("idrimborso");
            if (pol != null && pol.equals("M5")) {
                id = request.getParameter("idprgform");
            } else if(pol != null && (pol.equals("C06"))){
                id = request.getParameter("idprgform_dt");
            }
                ...
                <div class="page-content">                    
                    ...
                    <div class="row">
                        ...
                        <div class="alert bg-green-jungle alert-dismissible " style="text-align: center;color: white">
                            <button type="button" class="close" data-close="alert"></button>
                            <span><strong>Decreto liquidazione caricato con successo!</strong></span>
                        </div>
                        ...
                        <div class="portlet light bordered ">
                            <div class="portlet-title">
                                <div class="caption">
                                    <span class="caption-subject font-blue bold">
                                        <h3 class="page-title"><strong> Rimborso <%=nome%> </strong><small> CARICA DECRETO LIQUIDAZIONE</small> </h3>                                    
                                    </span>
                                </div>
                            </div>
                            ...
                            <script type="text/javascript">
                                function ctrlForm() {
                                    ...
                                    if (datad == "") {
                                        $("#div_datad").attr("class", "col-md-3 has-error");
                                        err = true;
                                    } else {
                                        $("#div_datad").attr("class", "col-md-3 has-success");
                                    }
                                    if (repertorio == "") {
                                        $("#div_repertorio").attr("class", "col-md-3 has-error");
                                        err = true;
                                    } else {
                                        $("#div_repertorio").attr("class", "col-md-3 has-success");
                                    }
                                    if (datar == "") {
                                        $("#div_datar").attr("class", "col-md-3 has-error");
                                        err = true;
                                    } else {
                                        $("#div_datar").attr("class", "col-md-3 has-success");
                                    }
                                    if (!ctrlFile('file')) {
                            ...
                            <div class="portlet-body form">
                                <form class="form-horizontal" action="<%="OperazioniRegional?type=12"%>" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();" enctype="multipart/form-data">
                                    <%if (pol != null) {%>
                                    <input type="hidden" value="<%=pol%>" name="pol">
                                    <%}%>
                                    <input type="hidden" value="<%=id%>" name="idrimborso">
                                    <input type="hidden" value="<%=ctrlrimborso%>" name="ctrlrimborso">
                                    <div class="form-body">
                                        <div class="form-group">
                                            <div class="col-md-3" id="div_decreto">
                                                <label>Numero Decreto</label><label type="text" style="color: red" >*</label>
                                                <input class="form-control" type="text"  maxlength="10" id="decreto" name="decreto">
                                            </div>
                                            <div class="col-md-3" id="div_datad">
                                                <label>Data Decreto</label><label type="text"  style="color: red" >*</label>
                                                <div class="input-group input-medium date date-picker" style="width: 100%!important;" data-date-format="dd/mm/yyyy">
                                                    <input type="text" class="form-control" id="datad" name="datad" autocomplete="off">
                                            ...
                                            <div class="col-md-4" id="div_file">
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <label>PDF Decreto</label><label type="text" style="color: red" >*</label>
                                                    <div class="input-group input-large">
                                                        ...
                                                        <span class="input-group-addon btn default btn-file">
                                                            ...
                                                            <input type="file" accept="application/pdf" id="file" name="file" onchange="ctrlFile('file');"></span>                                                    
                                        ...
                                        <div class="form-group" hidden>
                                            <div class="col-md-3" id="div_repertorio">
                                                <label>Numero di Assunzione</label><label type="text" style="color: red" >*</label>
                                                <input class="form-control" type="text" value="-" maxlength="10" id="repertorio" name="repertorio">
                                            </div>
                                            <div class="col-md-3" id="div_datar">
                                                <label>Data Assunzione</label><label type="text" style="color: red" >*</label>
                                                <div class="input-group input-medium date date-picker" style="width: 100%!important;" data-date-format="dd/mm/yyyy">
                                                    <input type="text" class="form-control" value="1/01/1900" id="datar" name="datar" autocomplete="off">
                                                    <span class="input-group-btn">
                                                        <button class="btn default" type="button">
                                                            <i class="fa fa-calendar"></i>
                                                        </button>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-4"> 
                                                <button type="submit" class="btn blue-soft btn-outline"><i class="fa fa-upload"></i> Conferma</button>                                            
                                            </div>
                                        </div>
                                    </div>
                                </form>
