...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "resultRegister.jsp")) {
...
<html>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu_ente/menu_registri.jsp"%>
            <!-- END MENU -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"><strong>REGISTRI </strong><small>LIQUIDATI</small></h3>
                    ...
                    <div class="portlet box blue-soft">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="resultRegister.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3" id='div_date'>
                                            <label>Periodo Data Caricamento</label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="resutltRegister.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="portlet box green-jungle">
                                ...
                                <div class="portlet-body">
                                    <table width="100%" class="table table-responsive table-bordered table-scrollable dataTable no-footerr" id="sample_0"> 
                                        ...
                                        <th><center>Periodo<br>Riferimento </center> </th>
                                        <th><center>Durata  </center> </th>
                                        <th><center>Motivo </center> </th>
                                        <th><center>Tot. Erogato</center> </th>
                                        <th><center>Data Caricamento<br>Registro </center> </th>
                                ...
                                jQuery(document).ready(function () {
                                    var dt2 = function () {
                                        ...
                                        g.dataTable({
                                            ...
                                            processing: true,
                                            ajax: {
                                                url: "QueryEnte?type=11&stato=P&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>&from=<%=from%>&to=<%=to%>",
                                                dataSrc: "aaData",
                                                type: "GET"
                                            },
