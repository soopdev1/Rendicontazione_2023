...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "addProgettoFormativo.jsp")) {
            response.sendRedirect("page_403.html");
        } else {
            //Etichette et = new Etichette("IT");

            //ArrayList<Convenzione> convenzioni = Action.getConvenzioni((int)session.getAttribute("idente"));
            ArrayList<Tutor> tutor = Action.getListTutorEnte((int) session.getAttribute("idente"));
            ArrayList<Lavoratore> lavoratori = Action.getEnteLavoratoriAttivi((String) session.getAttribute("cf_ente"));
%>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <script type="text/javascript">
            ...
            function ctrlForm() {
                ...
                if (titolo == "") {
                    $("#div_titolo").attr("class", "col-md-3 has-error");
                    err = true;
                } else {
                    $("#div_titolo").attr("class", "col-md-3 has-success");
                }
                if (lavoratore == null || lavoratore == "...") {
                    $("#div_lavoratore").attr("class", "col-md-3 has-error");
                    err = true;
                } else {
                    $("#div_lavoratore").attr("class", "col-md-3 has-success");
                }
                if (tutor == null || tutor == "...") {
                ...
                if (from == "" || to == "") {
                    ...
                    $("#div_date").attr("class", "col-md-3 has-success");
                }
                if (ore == "") {
                    $("#div_ore").attr("class", "col-md-3 has-error");
                    err = true;
                } else {
                    $("#div_ore").attr("class", "col-md-3 has-success");
                }
                if (scadenza == "") {
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu_ente/menu_ProgettoFormativo.jsp"%>
            <!-- END MENU -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"><strong> PROGETTO FORMATIVO </strong><small> AGGIUNGI</small> </h3>
                    ...
                    <div class="alert bg-red-thunderbird  alert-dismissible " style="text-align: center;color: white">
                        ...
                        <span><strong>Errore, Convenzione non salvata! Riprovare</strong></span>            
                    </div>
                    <%} else if (esitoins.equals("OK")) {%> 
                    <br>
                    <div class="alert bg-green-jungle alert-dismissible " style="text-align: center;color: white">
                        <button type="button" class="close" data-close="alert"></button>
                        <span><strong>Convenzione aggiunta con successo!</strong></span>
                    </div>
                    <%}%>
                    <div class="portlet box blue-soft">
                        <div class="portlet-title">
                            <div class="caption">  
                                ...
                                <span class="caption-subject font-white bold ">Aggiungi</span>
                            </div>
                        </div>

                        <div class="portlet-body form">
                            <form class="form-horizontal" action="<%="OperazioniEnte?type=6"%>" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();" enctype="multipart/form-data">
                                <div class="form-body">
                                    <div class="form-group">
                                        <div class="col-md-3" id="div_titolo">
                                            <label>Titolo</label><label type="text" style="color: red" >*</label>
                                            <input type="text" class="form-control" id="titolo" name="titolo">
                                        </div>
                                        <div class="col-md-3" id='div_date'>
                                            <label>Inizio e Fine</label><label type="text" style="color: red" >*</label>
                                        ...
                                        <div class="col-md-3" id="div_ore">
                                            <label>Tot. Ore</label><label type="text" style="color: red" >*</label>
                                            <input type="number" min="0" step="10" max='999' maxlength='3' class="form-control" id="ore" name="ore">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-3" id="div_lavoratore">
                                            <label>Destinatario</label><label type="text" style="color: red" >*</label>
                                            <select class="form-control select2-allow-clear" id="lavoratore" name="lavoratore">
                                                <option value="...">...</option>
                                                <%for (Lavoratore l : lavoratori) {%>
                                                <option value="<%=l.getCdnlavoratore()%>"><%=l.getNome()%> <%=l.getCognome()%></option>
                                                <%}%>
                                            </select>
                                        </div>
                                        <div class="col-md-3" id="div_scadenza">
                                            <label>Scadenza C.I.</label><label type="text" style="color: red" >*</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3" id="div_convenzione" style="display: none;">
                                            <label>Convenzione</label><label type="text" style="color: red" >*</label>
                                            <select class="form-control select2-allow-clear" id="convenzione" name="convenzione">
                                                <option value="...">...</option>
                                                <%//for (Convenzione conv : convenzioni) {%>
                                                <option value="<%//conv.getCodice()%>"><%//conv.getCodice()%></option>
                                                <%//}%>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group" style="display: none">
                                        <div class="col-md-3" id="div_name">
                                            <label>Codice</label><label type="text" style="color: red" >*</label>
                                            <input type="text" class="form-control" id="Codice4" name="Codice4">
                                        </div>
                                        <div class="col-md-3">
                                            <label>Inizio e Fine</label><label type="text" style="color: red" >*</label>
                                            <div class="input-group date-picker input-daterange" data-date="01/01/1800" data-date-format="dd/mm/yyyy">
                                                <input type="text" class="form-control" name="from4" id="from">
                                                <span class="input-group-addon"> a </span>
                                                <input type="text" class="form-control" name="to4" id="to"> 
                                            </div>
                                        </div>
                                        <div class="col-md-3" id="div_file">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <label>Carta d'Identit&agrave;</label><label type="text" style="color: red" >*</label>
                                                <div class="input-group input-large">
                                                    <div class="form-control uneditable-input input-fixed input-medium" data-trigger="fileinput">
                                                        <i class="fa fa-file fileinput-exists"></i>&nbsp;
                                                        <span class="fileinput-filename"> </span>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4"> 
                                            <button type="submit" class="btn blue-soft btn-outline"><i class="fa fa-plus"></i> Salva</button>                                            
                                        </div>
                                    </div>
                                </div>
                            </form>
