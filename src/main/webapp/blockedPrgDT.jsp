...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "blockedPrgDT.jsp")) {
...
<html>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                ...
                <div class="page-content">
                    ...
                    <div class="portlet box blue-soft" style="display: none;">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="blockedPrgDT.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-group">
                                    <div class="col-md-4">
                                        ...
                                        <a href="blockedPrgDT.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <script type="text/javascript">
            ...
            <%if (true) {%>
                                ajax: {
                                url:"QueryEnte?type=12&stato=K&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>&from=<%=from%>&to=<%=to%>&politica=C06",
                                        dataSrc: "aaData",
                                        type: "GET"
                                },
            <%}%>
