...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "searchConvenzione.jsp")) {
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"><strong> CONVENZIONE </strong><small> CERCA</small> </h3>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue-soft">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <a class="fa fa-pencil white tooltips" style="cursor: default;color: white;"></a>
                                ...
                                <div class="portlet-body">
                                    <table width="100%" class="table table-responsive table-bordered table-scrollable dataTable no-footerr" id="sample_0"> 
                                        ...
                                        <th><center>Codice </center> </th>
                                        <th><center>Inizio </center> </th>
                                        <th><center>Fine </center> </th>
                                        <th><center>Bando </center> </th>
