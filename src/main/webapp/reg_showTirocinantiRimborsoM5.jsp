...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "reg_showTirocinantiRimborsoM5.jsp")) {
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            document.getElementById('conferma_scarta').href = "OperazioniRegional?type=14&motivo=" + encodeURIComponent(motivo2) + "&idpf=" + $('#id_s').val() + "&idrimborso=" + $('#id_r').val();
            }
            } else {
            document.getElementById('conferma_scarta').href = "OperazioniRegional?type=14&motivo=" + encodeURIComponent(motivo) + "&idpf=" + $('#id_s').val() + "&idrimborso=" + $('#id_r').val();
            }
            ...
            document.getElementById('conferma_scarta1').href = "OperazioniRegional?type=15&motivo=" + encodeURIComponent(motivo12) + "&idpf=" + $('#id_s').val() + "&idrimborso=" + $('#id_r').val();
            }
            } else {
            document.getElementById('conferma_scarta1').href = "OperazioniRegional?type=15&motivo=" + encodeURIComponent(motivo1) + "&idpf=" + $('#id_s').val() + "&idrimborso=" + $('#id_r').val();
            }
    ...
    <body class="page-full-width page-content-white">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-red-thunderbird" style="color: white;">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        <h4 class="modal-title">Scarta Progetto Formativo</h4>
                    </div>
                    <div class="modal-body" id="largetext">                       
        ...
        <script type="text/javascript">
                                    ...
                                    language: {aria: {},
                                            ...
                                            processing: true,
                                            ajax: {
                                            url: "QueryRegional?type=11&idrimborso=<%=request.getParameter("idrimborso")%>&esi=<%=esiti%>",
                                                    dataSrc: "aaData",
                                                    type: "GET"
                                            },
