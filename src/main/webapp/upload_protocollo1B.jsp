...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "upload_protocollo1B.jsp")) {
                ...
                <div class="page-content">                    
                    ...
                    <div class="row">
                        ...
                        <div class="alert bg-green-jungle alert-dismissible " style="text-align: center;color: white">
                            <button type="button" class="close" data-close="alert"></button>
                            <span><strong>Protocollo caricato con successo!</strong></span>
                        </div>
                        ...
                        <div class="portlet light bordered ">
                            <div class="portlet-title">
                                <div class="caption">
                                    <span class="caption-subject font-blue bold">
                                        <h3 class="page-title"><strong> Rimborso <%=nome%> </strong><small> CARICA PROTOCOLLO</small> </h3>                                    
                                    </span>
                                </div>
                            </div>
                            ...
                            <script type="text/javascript">
                                function ctrlForm() {
                                    ...
                                    var err = false;
                                    if (protocollo == "") {
                                        $("#div_protocollo").attr("class", "col-md-3 has-error");
                                        err = true;
                                    } else {
                                        $("#div_protocollo").attr("class", "col-md-3 has-success");
                                    }
                                    if (!ctrlFile('file')) {
                            ...
                            <div class="portlet-body form">
                                <form class="form-horizontal" action="<%="OperazioniRegional?type=11"%>" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();" enctype="multipart/form-data">
                                    <%if (pol != null) {%>
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            <div class="col-md-3" id="div_protocollo">
                                                <label>Protocollo</label><label type="text" style="color: red" >*</label>
                                                <input class="form-control" type="text" id="protocollo" name="protocollo">
                                            </div>
                                            <div class="col-md-4" id="div_file">
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <label>PDF Domanda Rimborso</label><label type="text" style="color: red" >*</label>
