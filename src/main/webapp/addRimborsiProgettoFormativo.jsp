...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "addRimborsiProgettoFormativo.jsp")) {
...
<html>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <form action="OperazioniEnte?type=13" method="post" id="form2" accept-charset="ISO-8859-1" style="display: none">
            <input type="hidden" name="page" value="addRimborsiProgettoFormativo.jsp">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"><strong> PROGETTO FORMATIVO</strong><small> RICHIEDI RIMBORSO</small></h3>
                    ...
                    <div class="portlet box blue-soft">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="addRimborsiProgettoFormativo.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="addRimborsiProgettoFormativo.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="portlet box blue-hoki">
                                ...
                                <div class="portlet-body">
                                    <table width="100%" class="table table-striped table-bordered table-hover order-column table-scrollable" id="sample_0"> 
                                        ...
                                        <th><center>Tot. Ore<br>Progetto</center> </th>
                                        <th><center>Ore Effettuate</center> </th>
                                        <th width="15%"><center>Documenti</center> </th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
        ...
        <script type="text/javascript">
            ...
            <%if (true) {%>
                                ajax: {
                                url: "QueryEnte?type=6&stato=C&politica=C06&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>&from=<%=from%>&to=<%=to%>",
                                        dataSrc: "aaData",
                                        type: "GET"
                                },
            <%}%>
