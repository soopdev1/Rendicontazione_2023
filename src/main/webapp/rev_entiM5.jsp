...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "rev_entiM5.jsp")) {
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function submitScarto() {
                ...
                if (motivo == null || motivo == "..." || motivo == "") {
                    ...
                    if (motivo2 == "") {
                        ...
                        document.getElementById('conferma_scarta').href = "OperazioniRevisore?type=2&motivo=" + motivo2 + "&idrimborso=" + $('#id_s').val() + "&pagina=rev_entiM5"
                                + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                    }
                } else {
                    document.getElementById('conferma_scarta').href = "OperazioniRevisore?type=2&motivo=" + motivo + "&idrimborso=" + $('#id_s').val() + "&pagina=rev_entiM5"
                            + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                }
            ...
            function submitScarto2() {
                ...
                if (motivo1 == null || motivo1 == "..." || motivo1 == "") {
                    ...
                    if (motivo12 == "") {
                        ...
                        document.getElementById('conferma_scarta1').href = "OperazioniRevisore?type=5&motivo=" + motivo12 + "&idrimborso=" + $('#id_s2').val() + "&pagina=rev_entiM5"
                                + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                    }
                } else {
                    document.getElementById('conferma_scarta1').href = "OperazioniRevisore?type=5&motivo=" + motivo1 + "&idrimborso=" + $('#id_s2').val() + "&pagina=rev_entiM5"
                            + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                }
            ...
            function ctrlForm() {
                ...
                if (!ctrlFile('file')) {
                    $("#div_file").attr("class", "col-md-4 input-group input-large has-error");
                    err = true;
                }
                if (err) {
                    return false;
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content ">
                    ...
                    <form class="form-horizontal" action="<%="OperazioniRevisore?type=5"%>" method="post" enctype="multipart/form-data" onsubmit="return ctrlFormScarto();">
                        ...
                        <input type="hidden" id="pagina" name="pagina" value="rev_entiM5">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->                    
                    <h3 class="page-title font-blue-chambray"><strong> M5 </strong>  <small class="font-blue-chambray"> AMMISSIBILITÀ INDENNITÀ ENTI </small> </h3>    
                    ...
                    <div class="portlet box purple-seance">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="rev_entiM5.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlRicerca();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="rev_entiM5.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="portlet box blue-chambray">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-white bold ">Domande Rimborso</span>
                                    </div>
                                    <div class="tools"> 
                                    </div>
                                </div>                               
                ...
                jQuery(document).ready(function () {
                    var dt2 = function () {
                        ...
                        g.dataTable({
                            ...
                            processing: true,
                            ajax: {
                                url: "QueryRevisore?type=5&politica=C06&ente=<%=ente%>&from=<%=from%>&to=<%=to%>",
                                dataSrc: "aaData",
                                type: "GET"
                            },
