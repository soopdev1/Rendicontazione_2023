...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "rev_showPFRimborsoDT.jsp")) {
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            document.getElementById('confirmdisactive').href = "OperazioniRevisore?type=12&idpolitica=" + id + "&idrimborso=" + id2;
            }
            ...
            document.getElementById('conferma_scarta').href = "OperazioniRevisore?type=11&motivo=" + encodeURIComponent(motivo2) + "&idpolitica=" + $('#id_s').val() + "&idrimborso=" + $('#id_r').val() + "&protocollo=<%=prot%>&politica=<%=pol%>";
            }
            } else {
            document.getElementById('conferma_scarta').href = "OperazioniRevisore?type=11&motivo=" + encodeURIComponent(motivo) + "&idpolitica=" + $('#id_s').val() + "&idrimborso=" + $('#id_r').val() + "&protocollo=<%=prot%>&politica=<%=pol%>";
            }
            ...
            document.getElementById('conferma_scarta1').href = "OperazioniRevisore?type=12&motivo=" + encodeURIComponent(motivo12) + "&idpolitica=" + $('#id_s1').val() + "&idrimborso=" + $('#id_r1').val() + "&protocollo=<%=prot%>&politica=<%=pol%>";
            }
            } else {
            document.getElementById('conferma_scarta1').href = "OperazioniRevisore?type=12&motivo=" + encodeURIComponent(motivo1) + "&idpolitica=" + $('#id_s1').val() + "&idrimborso=" + $('#id_r1').val() + "&protocollo=<%=prot%>&politica=<%=pol%>";
            }
    ...
    <body class="page-full-width page-content-white">
        ...
        <script type="text/javascript">
                                    ...
                                    language: {aria: {},
                                            ...
                                            processing: true,
                                            ajax: {
                                            url: "QueryRevisore?type=11&idrimborso=<%=request.getParameter("id")%>&esi=<%=esiti%>",
                                                    dataSrc: "aaData",
                                                    type: "GET"
                                            },
...
//
        ...
        <script type="text/javascript">
            ...
            language: {aria: {},
                    ...
                    processing: true,
                    ajax: {
                    url: "QueryRevisore?type=12&idrimborso=<%=request.getParameter("id")%>",
                            dataSrc: "aaData",
                            type: "GET"
                    },
                    drawCallback: function (settings, json) {
