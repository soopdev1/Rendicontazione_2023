...
<%
    ...
    String block_r = "";
    String gen_r = "";
    if (pageName.equals("addRimborsiD2.jsp")) {
        add_r = "active open";
    } else if (pageName.equals("anomalyRimborsoD2.jsp")) {
        anomaly_r = "active open";
    } else if (pageName.equals("resultRimborsoD2.jsp")) {
        result_r = "active open";
    } else if (pageName.equals("docRimborsiD2.jsp")) {
        doc_r = "active open";
    } else if (pageName.equals("negativeResultRimborsoD2.jsp")) {
        neg_r = "active open";
    } else if (pageName.equals("blockedRimborsoD2.jsp")) {
        block_r = "active open";
    } else if (pageName.equals("generatedRimborsoD2.jsp")) {
        gen_r = "active open";
    }
%>
            ...
            <li class="nav-item start active open">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item active open">
                        <a href="javascript:;" class="nav-link nav-toggle">
                            <i class="fa fa-arrow-down"></i> Politiche D2
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub-menu">
                            <li class="nav-item start <%=doc_r%>">
                                <a href="docRimborsiD2.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=add_r%>">
                                <a href="addRimborsiD2.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=anomaly_r%>">
                                <a href="anomalyRimborsoD2.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=block_r%>">
                                <a href="blockedRimborsoD2.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=gen_r%>">
                                <a href="generatedRimborsoD2.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=result_r%>">
                                <a href="resultRimborsoD2.jsp" class="nav-link ">
                                    <i class="fa fa-eur"></i>
                            ...
                            <li class="nav-item start <%=neg_r%>">
                                <a href="negativeResultRimborsoD2.jsp" class="nav-link ">
                                    <i class="fa fa-ban"></i>
