...
<%
    ...
    String block_r = "";
    String gen_r = "";
    if (pageName.equals("addRimborsi1B.jsp")) {
        add_r = "active open";
    } else if (pageName.equals("anomalyRimborso1B.jsp")) {
        anomaly_r = "active open";
    } else if (pageName.equals("resultRimborso1B.jsp")) {
        result_r = "active open";
    } else if (pageName.equals("docRimborsi1B.jsp")) {
        doc_r = "active open";
    } else if (pageName.equals("negativeResultRimborso1B.jsp")) {
        neg_r = "active open";
    } else if (pageName.equals("blockedRimborso1B.jsp")) {
        block_r = "active open";
    } else if (pageName.equals("generatedRimborso1B.jsp")) {
        gen_r = "active open";
    } 
%>
            ...
            <li class="nav-item start active open">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item active open">
                        <a href="javascript:;" class="nav-link nav-toggle">
                            <i class="fa fa-arrow-down"></i> Politica 1B
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub-menu">
                            <li class="nav-item start <%=doc_r%>">
                                <a href="docRimborsi1B.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=add_r%>">
                                <a href="addRimborsi1B.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=anomaly_r%>">
                                <a href="anomalyRimborso1B.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=block_r%>">
                                <a href="blockedRimborso1B.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=gen_r%>">
                                <a href="generatedRimborso1B.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=result_r%>">
                                <a href="resultRimborso1B.jsp" class="nav-link ">
                                    <i class="fa fa-eur"></i>
                            ...
                            <li class="nav-item start <%=neg_r%>">
                                <a href="negativeResultRimborso1B.jsp" class="nav-link ">
                                    <i class="fa fa-ban"></i>
