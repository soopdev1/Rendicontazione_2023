...
<%
    ...
    String block_r = "";
    String gen_r = "";
    if (pageName.equals("addRimborsiB1.jsp")) {
        add_r = "active open";
    } else if (pageName.equals("anomalyRimborsoB1.jsp")) {
        anomaly_r = "active open";
    } else if (pageName.equals("resultRimborsoB1.jsp")) {
        result_r = "active open";
    } else if (pageName.equals("docRimborsiB1.jsp")) {
        doc_r = "active open";
    } else if (pageName.equals("negativeResultRimborsoB1.jsp")) {
        neg_r = "active open";
    } else if (pageName.equals("blockedRimborsoB1.jsp")) {
        block_r = "active open";
    } else if (pageName.equals("generatedRimborsoB1.jsp")) {
        gen_r = "active open";
    }
%>
            ...
            <li class="nav-item start active open">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item active open">
                        <a href="javascript:;" class="nav-link nav-toggle">
                            <i class="fa fa-arrow-down"></i> Politiche B1
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub-menu">
                            <li class="nav-item start <%=doc_r%>">
                                <a href="docRimborsiB1.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=add_r%>">
                                <a href="addRimborsiB1.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=anomaly_r%>">
                                <a href="anomalyRimborsoB1.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=block_r%>">
                                <a href="blockedRimborsoB1.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=gen_r%>">
                                <a href="generatedRimborsoB1.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=result_r%>">
                                <a href="resultRimborsoB1.jsp" class="nav-link ">
                                    <i class="fa fa-eur"></i>
                            ...
                            <li class="nav-item start <%=neg_r%>">
                                <a href="negativeResultRimborsoB1.jsp" class="nav-link ">
                                    <i class="fa fa-ban"></i>
