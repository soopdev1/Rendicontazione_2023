...
<%
    ...
    String block_r = "";
    String gen_r = "";
    if (pageName.equals("addRimborsiB3.jsp")) {
        add_r = "active open";
    } else if (pageName.equals("anomalyRimborsoB3.jsp")) {
        anomaly_r = "active open";
    } else if (pageName.equals("resultRimborsoB3.jsp")) {
        result_r = "active open";
    } else if (pageName.equals("docRimborsiB3.jsp")) {
        doc_r = "active open";
    } else if (pageName.equals("negativeResultRimborsoB3.jsp")) {
        neg_r = "active open";
    } else if (pageName.equals("blockedRimborsoB3.jsp")) {
        block_r = "active open";
    } else if (pageName.equals("generatedRimborsoB3.jsp")) {
        gen_r = "active open";
    }
%>
            ...
            <li class="nav-item start active open">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item active open">
                        <a href="javascript:;" class="nav-link nav-toggle">
                            <i class="fa fa-arrow-down"></i> Politiche B3
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub-menu">
                            <li class="nav-item start <%=doc_r%>">
                                <a href="docRimborsiB3.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=add_r%>">
                                <a href="addRimborsiB3.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=anomaly_r%>">
                                <a href="anomalyRimborsoB3.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=block_r%>">
                                <a href="blockedRimborsoB3.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=gen_r%>">
                                <a href="generatedRimborsoB3.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=result_r%>">
                                <a href="resultRimborsoB3.jsp" class="nav-link ">
                                    <i class="fa fa-eur"></i>
                            ...
                            <li class="nav-item start <%=neg_r%>">
                                <a href="negativeResultRimborsoB3.jsp" class="nav-link ">
                                    <i class="fa fa-ban"></i>
