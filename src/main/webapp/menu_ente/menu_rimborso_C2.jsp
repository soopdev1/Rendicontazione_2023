...
<%
    ...
    String block_r = "";
    String gen_r = "";
    if (pageName.equals("addRimborsiC2.jsp")) {
        add_r = "active open";
    } else if (pageName.equals("anomalyRimborsoC2.jsp")) {
        anomaly_r = "active open";
    } else if (pageName.equals("resultRimborsoC2.jsp")) {
        result_r = "active open";
    } else if (pageName.equals("docRimborsiC2.jsp")) {
        doc_r = "active open";
    } else if (pageName.equals("negativeResultRimborsoC2.jsp")) {
        neg_r = "active open";
    } else if (pageName.equals("blockedRimborsoC2.jsp")) {
        block_r = "active open";
    } else if (pageName.equals("generatedRimborsoC2.jsp")) {
        gen_r = "active open";
    }
%>
            ...
            <li class="nav-item start active open">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item active open">
                        <a href="javascript:;" class="nav-link nav-toggle">
                            <i class="fa fa-arrow-down"></i> Politiche C2
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub-menu">
                            <li class="nav-item start <%=doc_r%>">
                                <a href="docRimborsiC2.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=add_r%>">
                                <a href="addRimborsiC2.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=anomaly_r%>">
                                <a href="anomalyRimborsoC2.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=block_r%>">
                                <a href="blockedRimborsoC2.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=gen_r%>">
                                <a href="generatedRimborsoC2.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=result_r%>">
                                <a href="resultRimborsoC2.jsp" class="nav-link ">
                                    <i class="fa fa-eur"></i>
                            ...
                            <li class="nav-item start <%=neg_r%>">
                                <a href="negativeResultRimborsoC2.jsp" class="nav-link ">
                                    <i class="fa fa-ban"></i>
