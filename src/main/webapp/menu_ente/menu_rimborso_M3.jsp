...
<%
    ...
    String block_r = "";
    String gen_r = "";
    if (pageName.equals("addRimborsiM3.jsp")) {
        add_r = "active open";
    } else if (pageName.equals("anomalyRimborsoM3.jsp")) {
        anomaly_r = "active open";
    } else if (pageName.equals("resultRimborsoM3.jsp")) {
        result_r = "active open";
    } else if (pageName.equals("docRimborsiM3.jsp")) {
        doc_r = "active open";
    } else if (pageName.equals("negativeResultRimborsoM3.jsp")) {
        neg_r = "active open";
    } else if (pageName.equals("blockedRimborsoM3.jsp")) {
        block_r = "active open";
    } else if (pageName.equals("generatedRimborsoM3.jsp")) {
        gen_r = "active open";
    }
%>
                    ...
                    <li class="nav-item active open">
                        ...
                        <ul class="sub-menu">
                            <li class="nav-item start <%=doc_r%>">
                                <a href="docRimborsiM3.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=add_r%>">
                                <a href="addRimborsiM3.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=anomaly_r%>">
                                <a href="anomalyRimborsoM3.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=block_r%>">
                                <a href="blockedRimborsoM3.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=gen_r%>">
                                <a href="generatedRimborsoM3.jsp" class="nav-link ">
                            ...
                            <li class="nav-item start <%=result_r%>">
                                <a href="resultRimborsoM3.jsp" class="nav-link ">
                                    <i class="fa fa-eur"></i>
                            ...
                            <li class="nav-item start <%=neg_r%>">
                                <a href="negativeResultRimborsoM3.jsp" class="nav-link ">
                                    <i class="fa fa-ban"></i>
