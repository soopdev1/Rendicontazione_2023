...
<%String user = session.getAttribute("username").toString();
    ...
    String gen_r = "";
    String ter = "";
    if (pageName.equals("addRimborsiPrgDT.jsp")) {
        add_r = "active open";
    } else if (pageName.equals("anomalyPrgDT.jsp")) {
        anomaly_r = "active open";
    } else if (pageName.equals("resultRimborsoPrgDT.jsp")) {
        result_r = "active open";
    } else if (pageName.equals("docPrgDT.jsp")) {
        doc_r = "active open";
    } else if (pageName.equals("negativeResultPrgDT.jsp")) {
        neg_r = "active open";
    } else if (pageName.equals("blockedPrgDT.jsp")) {
        block_r = "active open";
    } else if (pageName.equals("generatedRimborsoPrgDT.jsp")) {
        gen_r = "active open";
    } else if (pageName.equals("searchPrgDT.jsp")) {
        search_r = "active open";
    } else if (pageName.equals("finished_projects_dt.jsp")) {
        ter = "active open";
    }
                ...
                <ul class="sub-menu">
                    <li class="nav-item active open">
                        ...
                        <ul class="sub-menu">                            
                            <li class="nav-item start active open">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item start <%=doc_r%>">
                                        <a href="docPrgDT.jsp" class="nav-link ">
                                    ...
                                    <li class="nav-item start <%=search_r%>">
                                        <a href="searchPrgDT.jsp" class="nav-link ">
                                    ...
                                    <li class="nav-item start <%=ter%>">
                                        <a href="finished_projects_dt.jsp" class="nav-link ">
                                    ...
                                    <li class="nav-item start <%=add_r%>">
                                        <a href="addRimborsiPrgDT.jsp" class="nav-link ">
                                    ...
                                    <li class="nav-item start <%=anomaly_r%>">
                                        <a href="anomalyPrgDT.jsp" class="nav-link ">
                                    ...
                                    <li class="nav-item start <%=block_r%>">
                                        <a href="blockedPrgDT.jsp" class="nav-link ">
                                    ...
                                    <li class="nav-item start <%=gen_r%>">
                                        <a href="generatedRimborsoPrgDT.jsp" class="nav-link ">
                                    ...
                                    <li class="nav-item start <%=result_r%>">
                                        <a href="resultRimborsoPrgDT.jsp" class="nav-link ">
                                            <i class="fa fa-eur"></i>
                                    ...
                                    <li class="nav-item start <%=neg_r%>">
                                        <a href="negativeResultPrgDT.jsp" class="nav-link ">
                                            <i class="fa fa-ban"></i>
                            ...
                            <%@ include file="politiche_dt/C06/general_Registro.jsp"%>
                        </ul>
