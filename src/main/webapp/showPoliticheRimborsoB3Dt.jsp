...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "showPoliticheRimborsoB3Dt.jsp")) {
                            ...
                            jQuery(document).ready(function () {
                                var dt2 = function () {
                                    ...
                                    g.dataTable({
                                        ...
                                        processing: true,
                                        ajax: {
                                            url: "QueryEnte?type=23&politica=<%=request.getParameter("politica")%>&idrimborso=<%=request.getParameter("id")%>",
                                            dataSrc: "aaData",
                                            type: "GET"
                                        },
            ...
            jQuery(document).ready(function () {
                var dt2 = function () {
                    ...
                    g.dataTable({
                        ...
                        processing: true,
                        ajax: {
                            url: "QueryEnte?type=24&idrimborso=<%=request.getParameter("id")%>&politica=<%=request.getParameter("politica")%>",
                            dataSrc: "aaData",
                            type: "GET"
                        },
                        drawCallback: function (settings, json) {
