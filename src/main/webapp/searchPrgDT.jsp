...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "searchPrgDT.jsp")) {
...
<html>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"><strong> ACCOMPAGNAMENTO AL TIROCINIO</strong><small> GESTIONE</small></h3>
                    ...
                    <div class="portlet box blue-soft">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="searchPrgDT.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="searchPrgDT.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue-hoki">
                                ...
                                <div class="portlet-body">
                                    <table width="100%" class=" table-responsive table-bordered table-scrollable dataTable no-footerr" id="sample_0">
                                        <thead>
                                            <tr>
                                                <th><center>Modifica</center></th>
                                        <th><center>Carica Registro</center></th>
        ...
        <script type="text/javascript">
            ...
            <%if (true) {%>
                                ajax: {
                                url: "QueryEnte?type=12&stato=S&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>&from=<%=from%>&to=<%=to%>&politica=C06",
                                        dataSrc: "aaData",
                                        type: "GET"
                                },
            <%}%>
