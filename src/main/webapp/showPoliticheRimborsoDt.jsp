    ...
    <body class="page-full-width page-content-white">
        ...
        <script type="text/javascript">
                            ...
                            language: {aria: {},
                                    ...
                                    processing: true,
                                    ajax: {
                                    url: "QueryEnte?type=19&politica=<%=request.getParameter("politica")%>&idrimborso=<%=request.getParameter("id")%>",
                                            dataSrc: "aaData",
                                            type: "GET"
                                    },
        ...
        <script type="text/javascript">
            ...
            language: {aria: {},
                    ...
                    processing: true,
                    ajax: {
                    url: "QueryEnte?type=20&idrimborso=<%=request.getParameter("id")%>&politica=<%=request.getParameter("politica")%>",
                            dataSrc: "aaData",
                            type: "GET"
                    },
                    drawCallback: function (settings, json) {
