...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "rev_showConvenzioni.jsp")) {
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box purple-wisteria">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <a class="fa fa-building white tooltips" style="cursor: default;color: white;"></a>
                                        <span class="caption-subject font-white bold "><strong>Convenzioni </strong><small><%=(String) request.getParameter("ente")%></small></span>
                                    </div>
                                    <div class="tools">
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <table width="100%" class="table table-responsive table-bordered table-scrollable dataTable no-footerr" id="sample_0"> 
                                        <thead>
                                            <tr>
                                                <th><center>Numero Repertorio</center> </th>
                            ...
                            jQuery(document).ready(function () {
                                var dt2 = function () {
                                    ...
                                    g.dataTable({
                                        ...
                                        processing: true,
                                        ajax: {
                                            url: "QueryRevisore?type=3&idente=<%=request.getParameter("idente")%>&bando=<%=request.getParameter("bando")%>&politica=<%=request.getParameter("politica")%>",
                                            dataSrc: "aaData",
                                            type: "GET"
                                        },
