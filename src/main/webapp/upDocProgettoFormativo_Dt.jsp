...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "upDocProgettoFormativo.jsp")) {
            ...
            ArrayList<Convenzione> convenzione = Action.getConvenzioni((int) session.getAttribute("idente"), "1", "C06");
            PrgFormativoDt prg = Action.getPrgFormativoByIdDt(id);
%>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <body class="page-full-width page-content-white">
                    ...
                    <div class="row">
                        ...
                        <div class="portlet light bordered ">
                            ...
                            <div class="portlet-body form">
                                <form class="form-horizontal" action="<%="OperazioniEnte?type=16"%>" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();" enctype="multipart/form-data">
                            ...
                            <div class="portlet-body form">
                                <form class="form-horizontal" action="<%="OperazioniEnte?type=16"%>" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm2();" enctype="multipart/form-data">
                                    <input type="hidden" value="<%=id%>" name="id">                                    
                                    ...
                                    <input type="hidden" value="<%=prg.getDoc_m5()%>" name="m5_old">
        ...
        <script type="text/javascript">
            ...
            <%if (prg.getStato() != null && !prg.getStato().equals("C")) {%>
                if ($("#file").val().split('\\').pop() != "" && $("#prg").val().split('\\').pop() != "" && $("#m5").val().split('\\').pop() != "") {
            ...
            <%} else {%>
                if ($("#file").val().split('\\').pop() != "" && $("#prg").val().split('\\').pop() != "" && $("#m5").val().split('\\').pop() != "" && $("#cert").val().split('\\').pop() != "") {
                    var file = Number(document.getElementById('file').files[0].size);
                    var prg = Number(document.getElementById('prg').files[0].size);
                    var m5 = Number(document.getElementById('m5').files[0].size);
                    var cert = Number(document.getElementById('cert').files[0].size);
                    if ((file + prg + m5 + cert) > 10485760) {
                        $("#a_file").css("display", "block");
                        $("#a_prg").css("display", "block");
                        $("#a_m5").css("display", "block");
