...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "show_CO_rev.jsp")) {
            ...
            <div class="portlet box blue-chambray">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-white bold ">Comunicazioni Obbligatorie</span>
                ...
                <div class="portlet-body">
                    <table width="100%" class="table table-responsive table-bordered table-scrollable dataTable no-footerr" id="sample_0"> 
                        ...
                        <th><center>CF Azienda</center> </th>
                        <th><center>CF Ente Promotore</center> </th>
                        <th><center>Mansioni</center> </th>
                        <th><center>Contratto</center> </th>
                        <th><center>Stato </center> </th>
                        <th><center>Data Invio CO</center> </th>
                        </tr>
                        </thead>
                        <tbody>
                        </tbody>
            ...
            jQuery(document).ready(function () {
                var dt2 = function () {
                    ...
                    g.dataTable({
                        ...
                        processing: true,
                        ajax: {
                            url: "QueryRevisore?type=21&idente=<%=request.getParameter("idente")%>&idlav=<%=request.getParameter("idlav")%>",
                            dataSrc: "aaData",
                            type: "GET"
                        },
