...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "rev_showVoucher.jsp")) {
    ...
    <body class="page-full-width page-content-white">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="portlet box blue-soft">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <a class="fa fa-ticket white tooltips" style="cursor: default;color: white;"></a>
                                    ...
                                    <div class="portlet box red-soft">
                                        ...
                                        <div class="portlet-body">
                                            <table width="100%" class="table table-responsive table-bordered table-scrollable dataTable no-footerr" id="sample_1"> 
                                                ...
                                                <th><center>Codice Fiscale </center> </th>
                                                <th><center>Ore </center> </th>
                                                <th width="30%"><center>Motivo </center> </th>
        ...
        <script type="text/javascript">
                                    ...
                                    language: {aria: {},
                                            ...
                                            processing: true,
                                            ajax: {
                                            url: "QueryRevisore?type=13&politica=<%=request.getParameter("politica")%>&idrimborso=<%=request.getParameter("id")%>&esi=<%=esiti%>",
                                                    dataSrc: "aaData",
                                                    type: "GET"
                                            },
        ...
        <script type="text/javascript">
            ...
            language: {aria: {},
                    ...
                    processing: true,
                    ajax: {
                    url: "QueryRevisore?type=14&idrimborso=<%=request.getParameter("id")%>",
                            dataSrc: "aaData",
                            type: "GET"
                    },
                    drawCallback: function (settings, json) {
