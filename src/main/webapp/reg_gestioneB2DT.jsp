...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "reg_gestioneB2DT.jsp")) {
...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function setIDAccettaRimborsi(id) {
                document.getElementById('confirmactive').href = 'OperazioniRegional?type=9&idrimborso=' + id + '&tipo=B2'+ "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
            }
            ...
            function submitScarto2() {
                ...
                if (motivo12 == null || motivo12 == "..." || motivo12 == "") {
                    ...
                    if (motivo22 == "") {
                        ...
                        document.getElementById('conferma_scarta2').href = "OperazioniRegional?type=10&motivo=" + encodeURIComponent(motivo22) + "&idrimborso=" + $('#id_s2').val() + '&tipo=B2'
                        + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                    }
                } else {
                    document.getElementById('conferma_scarta2').href = "OperazioniRegional?type=10&motivo=" + encodeURIComponent(motivo12) + "&idrimborso=" + $('#id_s2').val() + '&tipo=B2'
                    + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                }
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu_regional/menu_politicaB2.jsp"%>
            <!-- END MENU -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->                    
                    <h3 class="page-title" style="color:#2D5F8B"><strong> B2 </strong>  <small style="color:#2D5F8B"> GESTIONE </small> </h3>    
                    ...
                    <div class="portlet box red-flamingo">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="reg_gestioneB2DT.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="reg_gestioneB2DT.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                ...
                                jQuery(document).ready(function () {
                                    var dt2 = function () {
                                        ...
                                        g.dataTable({
                                            ...
                                            processing: true,
                                            ajax: {
                                                url: "QueryRegional?type=5&politica=B2&ente=<%=ente%>&from=<%=from%>&to=<%=to%>",
                                                dataSrc: "aaData",
                                                type: "GET"
                                            },
