...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "resultRimborsoProgettoFormativo.jsp")) {
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"><strong>PROGETTO FORMATIVO</strong><small> ESITI POSITIVI</small></h3>
                    ...
                    <div class="portlet box blue-soft">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="resultRimborsoProgettoFormativo.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3" id='div_date_mod'>
                                            <label>Periodo Liquidazione</label>
                                            <div class="input-group date-picker input-daterange" data-date="01/01/2000" data-date-format="dd/mm/yyyy">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            <a href="resultRimborsoProgettoFormativo.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green-jungle">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <a class="fa fa-thumbs-up white tooltips" style="cursor: default;color: white;"></a>
                                ...
                                <div class="portlet-body">
                                    <table width="100%" class="table table-responsive table-bordered table-scrollable dataTable no-footerr" id="sample_0"> 
                                        ...
                                        <th><center>Esito Revisore</center> </th>
                                        <th><center>Data Domanda Rimborso</center> </th>
                                        <th><center>Importo versato</center> </th>
                                ...
                                jQuery(document).ready(function () {
                                    var dt2 = function () {
                                        ...
                                        g.dataTable({
                                            ...
                                            processing: true,
                                            ajax: {
                                                url: "QueryEnte?type=8&stato=P&politica=C06&protocollo=<%=protocollo%>&from_up=<%=from_up%>&to_up=<%=to_up%>&from_mod=<%=from_mod%>&to_mod=<%=to_mod%>",
                                                dataSrc: "aaData",
                                                type: "GET"
                                            },
                                            ...
                                            columnDefs: [
                                                ...
                                                {orderable: !5, targets: [0]},
                                                {searchable: !5, targets: [0]}
                                            ],
                                            buttons: [
