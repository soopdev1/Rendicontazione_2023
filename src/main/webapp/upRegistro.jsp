...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "upRegistro.jsp")) {
            ...
            int mesi = Action.getRegisterNumber(idprg);
            String[] mese = Action.getMese(mesi + 1);
            String from = "";
            String to = "";
            int ore_tot = 0;
            Registro reg = Action.getLastRegister(idprg);
            ...
            if (reg != null) {
                ...
                ore_tot = Action.getTotlHourPrg(idprg);
            } else if (idprg != null) {
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function ctrlAllDim() {
                if ($("#file").val().split('\\').pop() != "" && $("#quietanza").val().split('\\').pop() != "") {
                    var file = Number(document.getElementById('file').files[0].size);
                    var quietanza = Number(document.getElementById('quietanza').files[0].size);
                    if ((file + quietanza) > 10485760) {
                        $("#a_file").css("display", "block");
                        $("#a_quietanza").css("display", "block");
                        $("#a_file").html("<i class='fa fa-exclamation-triangle'></i> Dimensione Dei File Eccessiva");
                        $("#a_quietanza").html("<i class='fa fa-exclamation-triangle'></i> Dimensione Dei File Eccessiva");
                        $("#div_file").attr("class", "col-md-4 has-error");
                        $("#div_quietanza").attr("class", "col-md-4 has-error");
                        return false;
                    } else {
                        resetDiv(file, 'file');
                        resetDiv(quietanza, 'quietanza');
                        return true;
                    }
                } else {
                    resetDiv(file, 'file');
...
//                                    return true;
                            ...
                            <div class="portlet-body form">
                                <form class="form-horizontal" action="<%="OperazioniEnte?type=12"%>" method="post" name="form" id="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();" enctype="multipart/form-data">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4" id="div_quietanza">
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <label>Quietanza Di Liquidazione</label><label type="text" style="color: red" >*</label>
                                                    <div class="input-group input-large">
                                                        <div class="form-control uneditable-input input-fixed input-medium" data-trigger="fileinput">
                                                            <i class="fa fa-file fileinput-exists"></i>&nbsp;
                                                            <span class="fileinput-filename"> </span>
