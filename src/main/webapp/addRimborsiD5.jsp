...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "addRimborsiD5.jsp")) {
...
<html>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <form action="OperazioniEnte?type=22" method="post" id="form2" accept-charset="ISO-8859-1" style="display: none">
            <input type="hidden" name="page" value="addRimborsiD5.jsp">
            ...
            <input type="hidden" name="politica" value="D5">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"><strong> D5 </strong><small> RICHIEDI RIMBORSO</small></h3>
                    ...
                    <div class="portlet box blue-soft">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="addRimborsiD5.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="addRimborsiD5.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <script type="text/javascript">
            ...
            <%if (true) {%>
                                ajax: {
                                url: "QueryEnte?type=17&stato=S&politica=D5&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>&from=<%=from%>&to=<%=to%>",
                                        dataSrc: "aaData",
                                        type: "GET"
                                },
            <%}%>
...
//                                                        {extend: "colvis", className: "btn white btn-outline", text: "Columns"},
                                        ...
                                        {className: "btn bg-green white btn-outline", text: "<i class='fa fa-upload' style='font-size: 16px'><font color='white' face='verdana'> Carica Domanda</font></i>",
                                                ...
                                                var chkbox_checked = $('tbody input[type="checkbox"]:checked', table);
                                                var check = "";
                                                var chkbox_checkeD5 = $('tbody input[type="checkbox"]:disabled', table);
                                                for (var r = 0, n = chkbox_checked.length; r < n; r++) {
                                                check = check + chkbox_checked[r].id + ",";
                                                }
                                                if (chkbox_checked.length === chkbox_checkeD5.length) {
