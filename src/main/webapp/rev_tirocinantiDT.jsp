...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "rev_tirocinantiDT.jsp")) {
            ...
            double[] prezziario = Action.getPrezziario("registro_dt", "1");
            ...
            function submitScarto() {
                ...
                if (motivo1 == null || motivo1 == "..." || motivo1 == "") {
                    ...
                    if (motivo2 == "") {
                        ...
                        document.getElementById('conferma_scarta').href = "OperazioniRevisore?type=9&motivo=" + encodeURIComponent(motivo2) + "&idregistri=" + $('#id_s').val() + '&tipo=' + $('#tipo_s').val()
                                + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>";
                    }
                } else {
                    document.getElementById('conferma_scarta').href = "OperazioniRevisore?type=9&motivo=" + encodeURIComponent(motivo1) + "&idregistri=" + $('#id_s').val() + '&tipo=' + $('#tipo_s').val()
                            + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>";
                }
            ...
            function submitScarto2() {
                ...
                if (motivo12 == null || motivo12 == "..." || motivo12 == "") {
                    ...
                    if (motivo22 == "") {
                        ...
                        document.getElementById('conferma_scarta2').href = "OperazioniRevisore?type=10&motivo=" + encodeURIComponent(motivo22) + "&idregistri=" + $('#id_s2').val() + '&tipo=' + $('#tipo_s2').val() + '&ore=' + ore2
                                + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>";
                    }
                } else {
                    document.getElementById('conferma_scarta2').href = "OperazioniRevisore?type=10&motivo=" + encodeURIComponent(motivo12) + "&idregistri=" + $('#id_s2').val() + '&tipo=' + $('#tipo_s2').val() + '&ore=' + ore2
                            + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>";
                }
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content ">
                    ...
                    <form class="form-horizontal" action="<%="OperazioniRevisore?type=8"%>" method="post" enctype="multipart/form-data" onsubmit="return ctrlForm2();">
                        ...
                        <input type="hidden" id="pagina" name="pagina" value="rev_tirocinantiDT">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->                    
                    <h3 class="page-title font-blue-chambray"><strong> ACCOMPAGNAMENTO AL TIROCINIO </strong>  <small class="font-blue-chambray"> AMMISSIBILITÀ INDENNITÀ DESTINATARI </small> </h3>    
                    ...
                    <div class="portlet box purple-seance">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="rev_tirocinantiDT.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="rev_tirocinantiDT.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                ...
                                jQuery(document).ready(function () {
                                    var dt2 = function () {
                                        ...
                                        g.dataTable({
                                            ...
                                            processing: true,
                                            ajax: {
                                                url: "QueryRevisore?type=9&politica=C06&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>",
                                                dataSrc: "aaData",
                                                type: "GET"
                                            },
            ...
            <script type="text/javascript">
                function showPrg(id) {
                    $.get('OperazioniRevisore?type=18&id=' + id, function (response) {
                        if (response != "") {
