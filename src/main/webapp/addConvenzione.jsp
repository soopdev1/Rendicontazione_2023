...
<html>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu_ente/menu_convenzione.jsp"%>
            <!-- END MENU -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"><strong> CONVENZIONE </strong><small> AGGIUNGI</small> </h3>
                    ...
                    <div class="portlet box blue-soft">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="<%="OperazioniEnte?type=4"%>" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();" enctype="multipart/form-data">
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3" id='div_date'>
                                            <label>Data Stipula e Scadenza</label><label type="text" style="color: red" >*</label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4" id="div_file">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <label>Documento</label><label type="text" style="color: red" >*</label>
                                                            ...
                                                            $('#bando').change(function () {
                                                                ...
                                                                if ($('#bando').val() != '...' && $('#bando').val() != null) {
                                                                    ...
                                                                    $.get("OperazioniEnte?type=31&bando=" + $('#bando').val(), function (response) {
                                                                        ...
                                                                        $('#politica').append("<option value='...' selected>...</option>");
