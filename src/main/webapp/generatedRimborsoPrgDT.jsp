...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "generatedRimborsoPrgDT.jsp")) {
            response.sendRedirect("page_403.html");
        } else {
//            ArrayList<String[]> politiche = Action.getListTipoPolitica("1", "Y");
//            String car = "";
//            for (String[] s : politiche) {
//                car += s[0] + "-";
//            }
//            String[] tmp = {car.substring(0, car.length() - 1), "Miste"};
//            politiche.add(tmp);
            String protocollo = request.getParameter("protocollo"),
                    politica = request.getParameter("politica"),
                    from_up = request.getParameter("from_up"),
                    to_up = request.getParameter("to_up"),
                    from_mod = request.getParameter("from_mod"),
                    to_mod = request.getParameter("to_mod");
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function ctrlForm() {
                ...
                var from_up = $("#from_up").val();
                var to_up = $("#to_up").val();
                var from_mod = $("#from_mod").val();
                var to_mod = $("#to_mod").val();
                var politica = $("#politica").val();
                var err = false;
                if (protocollo == "" && from_up == "" && to_up == "" && from_mod == "" && to_mod == "" && (politica == null || politica == "..." || politica == "")) {
                ...
                if ((from_up != "" && to_up == "") || (from_up == "" && to_up != "")) {
                    $("#div_date_up").attr("class", "col-md-3 has-error");
                    err = true;
                } else {
                    $("#div_date_up").attr("class", "col-md-3");
                }
                if ((from_mod != "" && to_mod == "") || (from_mod == "" && to_mod != "")) {
                    $("#div_date_mod").attr("class", "col-md-3 has-error");
                    err = true;
                } else {
                    $("#div_date_mod").attr("class", "col-md-3");
                }
                if (err) {
                    return false;
                }
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu_ente/menu_PrgForm_dote.jsp"%>
            <!-- END MENU -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"><strong>ACCOMPAGNAMENTO AL TIROCINIO</strong><small> DOMANDE IN ATTESA</small></h3>
                    ...
                    <%}%>
                    <div class="portlet box blue-soft" style="display: none;">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="generatedRimborsoProgettoFormativoDT.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    <div class="form-group">
                                        <div class="col-md-3" id="div_name">
                                            ...
                                            <input type="text" class="form-control" id="protocollo" name="protocollo" value="<%=protocollo%>">
                                        </div>
                                        <div class="col-md-3" id='div_date_up'>
                                            ...
                                            <div class="input-group date-picker input-daterange" data-date="01/01/2000" data-date-format="dd/mm/yyyy">
                                                <input type="text" class="form-control" name="from_up" id="from_up" autocomplete="off" value="<%=from_up%>">
                                                <span class="input-group-addon"> a </span>
                                                <input type="text" class="form-control" name="to_up" id="to_up" autocomplete="off" value="<%=to_up%>"> 
                                            </div>
                                        </div>
                                        <div class="col-md-3" id='div_date_mod'>
                                            <label>Periodo Ultima Modifica</label>
                                            <div class="input-group date-picker input-daterange" data-date="01/01/2000" data-date-format="dd/mm/yyyy">
                                                <input type="text" class="form-control" name="from_mod" id="from_mod" autocomplete="off" value="<%=from_mod%>">
                                                <span class="input-group-addon"> a </span>
                                                <input type="text" class="form-control" name="to_mod" id="to_mod" autocomplete="off" value="<%=to_mod%>"> 
                                            </div>
                                        </div>
                                    </div>
                                    <br><br>
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="generatedRimborsoProgettoFormativoDT.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet box purple-wisteria">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <a class="fa fa-spinner" style="cursor: default;color: white;"></a>
                                ...
                                <div class="portlet-body">
                                    <table width="100%" class="table table-responsive table-bordered table-scrollable dataTable no-footerr" id="sample_0"> 
                                        ...
                                        <th><center>Data Generazione</center> </th>
                                        <th><center>Scarica Elenco</center> </th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
                                ...
                                jQuery(document).ready(function () {
                                    var dt2 = function () {
                                        ...
                                        g.dataTable({
                                            ...
                                            processing: true,
                                            ajax: {
                                                url: "QueryEnte?type=13&stato=S&politica=C06&protocollo=<%=protocollo%>&from_up=<%=from_up%>&to_up=<%=to_up%>&from_mod=<%=from_mod%>&to_mod=<%=to_mod%>",
                                                dataSrc: "aaData",
                                                type: "GET"
                                            },
                                            ...
                                            columnDefs: [
                                                ...
                                                {orderable: !2, targets: [0]},
                                                {searchable: !2, targets: [0]}
                                            ],
                                            buttons: [
