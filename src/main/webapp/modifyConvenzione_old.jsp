                                ...
                                <form class="form-horizontal" action="<%="OperazioniEnte?type=5"%>" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();" enctype="multipart/form-data">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3" id="div_politica">
                                                <label>Politica</label><label type="text" style="color: red" >*</label>
                                                <select class="form-control select2-allow-clear" id="politica" name="politica">
                                                    <option value="...">...</option>
                                                    <%for (int i = 0; i < politica.size(); i++) {
                                                            if (politica.get(i)[0].equals(t.getPolitica())) {%>
                                                    <option selected value="<%=politica.get(i)[0]%>"><%=politica.get(i)[1]%></option>
                                                    <%} else {%>
                                                    <option value="<%=politica.get(i)[0]%>"><%=politica.get(i)[1]%></option>
                                                    <%}
                                                        }%>
                                                </select>
                                            </div>
                                        ...
                                        <br><label type="text" style="color: red">** I documenti resteranno inveriatio se non ricaricati</label><br><br>
                                        <div class="form-group">
                                            <div class="col-md-4"> 
