...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "modifyRegistroDt.jsp")) {
                ...
                <div class="page-content">                    
                    ...
                    <div class="row">
                        ...
                        <%} else if (esitoins.equals("") && esitolast.equals("")) {
                            ...
                            RegistroDt reg = Action.getRegistroByIdDT(idrg);
                        ...
                        <div class="portlet light bordered ">
                            ...
                            <div class="portlet-body form">
                                <form class="form-horizontal" action="<%="OperazioniEnte?type=20"%>" method="post" name="form" id="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();" enctype="multipart/form-data">
