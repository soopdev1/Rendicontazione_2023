...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "rev_liquidazione1C.jsp")) {
            ...
            function submitScarto() {
                ...
                if (motivo == null || motivo == "..." || motivo == "") {
                    ...
                    if (motivo2 == "") {
                        ...
                        document.getElementById('conferma_scarta').href = "OperazioniRevisore?type=2&motivo=" + encodeURIComponent(motivo2) + "&idrimborso=" + $('#id_s').val() + "&pagina=rev_liquidazione1C"
                                + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                    }
                } else {
                    document.getElementById('conferma_scarta').href = "OperazioniRevisore?type=2&motivo=" + encodeURIComponent(motivo) + "&idrimborso=" + $('#id_s').val() + "&pagina=rev_liquidazione1C"
                            + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                }
            ...
            function submitScarto2() {
                ...
                if (motivo1 == null || motivo1 == "..." || motivo1 == "") {
                    ...
                    if (motivo12 == "") {
                        ...
                        document.getElementById('conferma_scarta1').href = "OperazioniRevisore?type=5&motivo=" + encodeURIComponent(motivo12) + "&idrimborso=" + $('#id_s2').val() + "&pagina=rev_liquidazione1C"
                                + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                    }
                } else {
                    document.getElementById('conferma_scarta1').href = "OperazioniRevisore?type=5&motivo=" + encodeURIComponent(motivo1) + "&idrimborso=" + $('#id_s2').val() + "&pagina=rev_liquidazione1C"
                            + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                }
...
//            }
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content ">
                    ...
                    <form class="form-horizontal" action="<%="OperazioniRevisore?type=5"%>" method="post" enctype="multipart/form-data" onsubmit="return ctrlFormScarto();">
                        ...
                        <input type="hidden" id="pagina" name="pagina" value="rev_liquidazione1C">
        ...
        <div class="modal fade bs-modal-lg" id="accettamodal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content ">
                    ...
                    <form class="form-horizontal" action="<%="OperazioniRevisore?type=1"%>" method="post" id="accettaform" enctype="multipart/form-data" onsubmit="return ctrlForm();">
                        <br>
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu_revisore/menu_politica1C.jsp"%>
            <!-- END MENU -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->                    
                    <h3 class="page-title font-blue-chambray"><strong> 1C </strong>  <small class="font-blue-chambray"> AMMISSIBILITÀ INDENNITÀ </small> </h3>    
                    ...
                    <div class="portlet box purple-seance">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="rev_liquidazione1C.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlRicerca();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="rev_liquidazione1C.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                ...
                                jQuery(document).ready(function () {
                                    var dt2 = function () {
                                        ...
                                        g.dataTable({
                                            ...
                                            processing: true,
                                            ajax: {
                                                url: "QueryRevisore?type=1&politica=B05&ente=<%=ente%>&from=<%=from%>&to=<%=to%>",
                                                dataSrc: "aaData",
                                                type: "GET"
                                            },
