...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "rev_entiDT.jsp")) {
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function setScartaID(id) {
                $('#id_s').val(id);
                $('#tipo_s').val(document.getElementById(id + '_pol').value);
            }
            function setScartaID2(id) {
                $('#id_s2').val(id);
                $('#tipo_s2').val(document.getElementById(id + '_pol').value);
            ...
            function setAccettaID(id) {
                $('#idrimborso').val(id);
                $('#idtipo').val(document.getElementById(id + '_pol').value);
            }
            ...
            function submitScarto() {
                ...
                if (motivo == null || motivo == "..." || motivo == "") {
                    ...
                    if (motivo2 == "") {
                        ...
                        document.getElementById('conferma_scarta').href = "OperazioniRevisore?type=2&motivo=" + motivo2 + "&idrimborso=" + $('#id_s').val() + "&pagina=" + $('#tipo_s').val()
                                + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                    }
                } else {
                    document.getElementById('conferma_scarta').href = "OperazioniRevisore?type=2&motivo=" + motivo + "&idrimborso=" + $('#id_s').val() + "&pagina=" + $('#tipo_s').val()
                            + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                }
            ...
            function submitScarto2() {
                ...
                if (motivo1 == null || motivo1 == "..." || motivo1 == "") {
                    ...
                    if (motivo12 == "") {
                        ...
                        document.getElementById('conferma_scarta1').href = "OperazioniRevisore?type=5&motivo=" + motivo12 + "&idrimborso=" + $('#id_s2').val() + "&pagina=" + $('#tipo_s2').val()
                                + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                    }
                } else {
                    document.getElementById('conferma_scarta1').href = "OperazioniRevisore?type=5&motivo=" + motivo1 + "&idrimborso=" + $('#id_s2').val() + "&pagina=" + $('#tipo_s2').val()
                            + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                }
            ...
            function ctrlForm() {
                ...
                var err = false;
                if (descrizione == "") {
                    $("#div_descrizione").attr("class", "has-error");
                    err = true;
                }

                if (totale == "" || totale == "0") {
                    $("#div_totale").attr("class", "has-error");
                    err = true;
                }
            ...
            function ctrlRicerca() {
                ...
                var err = false;
                if ((ente == null || ente == "...") && from == "" && to == "" && politica == "") {
...
//            }
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="modal fade bs-modal-lg" id="scartamodal" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content ">
                    <div class="modal-header alert-warning" style="color:white;">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    ...
                    <div class="modal-footer">
                        <div class="form-group">                             
                            <div class="col-md-12"> 
                                ...
                                <a class="btn btn-success large " id="conferma_scarta13" onclick="return submitScarto2();">Conferma</a>                                                                      
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal fade bs-modal-lg" id="scartamodal1" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content ">
                    ...
                    <form class="form-horizontal" action="<%="OperazioniRevisore?type=5"%>" method="post" enctype="multipart/form-data" onsubmit="return ctrlFormScarto();">
                        <br>
                        <input type="hidden" id="idrimborsoscarto" name="idrimborsoscarto">
                        <input type="hidden" id="pagina" name="pagina" value="rev_entiDT">
                        ...
                        <div class="fileinput fileinput-new col-md-4" data-provides="fileinput">
                            ...
                            <div class="col-md-11 pull-left" style="padding-left: 0px;padding-right: 7px;">
        ...
        <div class="modal fade bs-modal-lg" id="accettamodal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content ">
                    ...
                    <form class="form-horizontal" action="<%="OperazioniRevisore?type=1"%>" method="post" enctype="multipart/form-data" onsubmit="return ctrlForm();">
                        <br>
                        ...
                        <div class="col-md-1" id="div_centesimi" style=" padding-left: 0px; width: 10%; ">
                            <label>&nbsp;</label>
                            <input class="form-control" type="number" id="centesimi" name="centesimi" readonly placeholder="00" value="00" min="0" max="99" step="1" >
                        </div>
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu_revisore/menu_politicaDT.jsp"%>
            <!-- END MENU -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->                    
                    <h3 class="page-title font-blue-chambray"><strong> ACCOMPAGNAMENTO AL TIROCINIO </strong>  <small class=" font-blue-chambray"> AMMISSIBILITÀ INDENNITÀ ENTI </small> </h3>    
                    ...
                    <div class="portlet box purple-seance">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="rev_entiDT.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlRicerca();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="rev_entiDT.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue-chambray">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span class="fa fa-building-o font-white tooltips"></span>
                                        <span class="caption-subject font-white bold ">Domande Rimbroso</span>
                                    </div>
                                    <div class="tools"> 
                                    </div>
                                </div>                               
                ...
                jQuery(document).ready(function () {
                    var dt2 = function () {
                        ...
                        g.dataTable({
                            ...
                            processing: true,
                            ajax: {
                                url: "QueryRevisore?type=10&politica=C06&ente=<%=ente%>&from=<%=from%>&to=<%=to%>",
                                dataSrc: "aaData",
                                type: "GET"
                            },
