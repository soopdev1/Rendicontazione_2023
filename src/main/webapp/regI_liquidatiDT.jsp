...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "regI_liquidatiDT.jsp")) {
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->                    
                    <h3 class="page-title" style="color:#2D5F8B"><strong> ACCOMPAGNAMENTO AL TIROCINIO </strong>  <small style="color:#2D5F8B"> LIQUIDATI </small> </h3>    
                    ...
                    <div class="portlet box red-flamingo">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="regI_liquidatiDT.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="regI_liquidatiDT.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue-soft">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span class="fa fa-euro font-white tooltips"></span>
                                        <span class="caption-subject font-white bold ">Rimborsi liquidati</span>
                                    </div>
                                    <div class="tools"> 
                                    </div>
                                </div>                               
                                <div class="portlet-body">                                  
                                    <table width="100%" class="table table-striped table-bordered table-hover order-column table-scrollable" id="sample_0"> 
                                        ...
                                        <th><center>Liquidazione INPS </center> </th>                    
                                ...
                                jQuery(document).ready(function () {
                                    var dt2 = function () {
                                        ...
                                        g.dataTable({
                                            ...
                                            processing: true,
                                            ajax: {
                                                url: "QueryRegional?type=28&politica=C06&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>",
                                                dataSrc: "aaData",
                                                type: "GET"
                                            },
