...
<%
    ...
    String liq = "";
    String esiti = "";
    if (pageName.equals("reg_protocolloB3DT.jsp")) {
        prot = "active open";
    } else if (pageName.equals("reg_gestioneB3DT.jsp")) {
        gest = "active open";
    } else if (pageName.equals("reg_anomalieB3DT.jsp")) {
        anom = "active open";
    } else if (pageName.equals("reg_liquidazioneB3DT.jsp")) {
        liq = "active open";
    } else if (pageName.equals("reg_esitiB3DT.jsp")) {
        esiti = "active open";
    }
%>
                    ...
                    <li class="nav-item active open">
                        ...
                        <ul class="sub-menu">
                            <li class="nav-item start <%=prot%>">
                                <a href="reg_protocolloB3DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=gest%>">
                                <a href="reg_gestioneB3DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=anom%>">
                                <a href="reg_anomalieB3DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=liq%>">
                                <a href="reg_liquidazioneB3DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=esiti%>">
                                <a href="reg_esitiB3DT.jsp" class="nav-link nav-toggle">
