...
<%
    ...
    String liq = "";
    String esiti = "";
    if (pageName.equals("reg_protocolloD2DT.jsp")) {
        prot = "active open";
    } else if (pageName.equals("reg_gestioneD2DT.jsp")) {
        gest = "active open";
    } else if (pageName.equals("reg_anomalieD2DT.jsp")) {
        anom = "active open";
    } else if (pageName.equals("reg_liquidazioneD2DT.jsp")) {
        liq = "active open";
    } else if (pageName.equals("reg_esitiD2DT.jsp")) {
        esiti = "active open";
    }
%>
            ...
            <li class="nav-item start active open">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item active open">
                        <a href="javascript:;" class="nav-link nav-toggle">
                            <i class="fa fa-arrow-down"></i> Politica D2
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub-menu">
                            <li class="nav-item start <%=prot%>">
                                <a href="reg_protocolloD2DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=gest%>">
                                <a href="reg_gestioneD2DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=anom%>">
                                <a href="reg_anomalieD2DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=liq%>">
                                <a href="reg_liquidazioneD2DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=esiti%>">
                                <a href="reg_esitiD2DT.jsp" class="nav-link nav-toggle">
