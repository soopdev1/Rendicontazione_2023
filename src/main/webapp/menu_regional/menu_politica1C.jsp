...
<%
    ...
    String liq = "";
    String esiti = "";
    if (pageName.equals("reg_protocollo1C.jsp")) {
        prot = "active open";
    } else if (pageName.equals("reg_gestione1C.jsp")) {
        gest = "active open";
    } else if (pageName.equals("reg_anomalie1C.jsp")) {
        anom = "active open";
    } else if (pageName.equals("reg_liquidazione1C.jsp")) {
        liq = "active open";
    }else if (pageName.equals("reg_esiti1C.jsp")) {
        esiti = "active open";
    }
%>
                    ...
                    <li class="nav-item active open">
                        ...
                        <ul class="sub-menu">
                            <li class="nav-item start <%=prot%>">
                                <a href="reg_protocollo1C.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=gest%>">
                                <a href="reg_gestione1C.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=anom%>">
                                <a href="reg_anomalie1C.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=liq%>">
                                <a href="reg_liquidazione1C.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=esiti%>">
                                <a href="reg_esiti1C.jsp" class="nav-link nav-toggle">
