...
<%
    ...
    String liq = "";
    String esiti = "";
    if (pageName.equals("reg_protocolloB1DT.jsp")) {
        prot = "active open";
    } else if (pageName.equals("reg_gestioneB1DT.jsp")) {
        gest = "active open";
    } else if (pageName.equals("reg_anomalieB1DT.jsp")) {
        anom = "active open";
    } else if (pageName.equals("reg_liquidazioneB1DT.jsp")) {
        liq = "active open";
    } else if (pageName.equals("reg_esitiB1DT.jsp")) {
        esiti = "active open";
    }
%>
            ...
            <li class="nav-item start active open">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item active open">
                        <a href="javascript:;" class="nav-link nav-toggle">
                            <i class="fa fa-arrow-down"></i> Politica B1
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub-menu">
                            <li class="nav-item start <%=prot%>">
                                <a href="reg_protocolloB1DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=gest%>">
                                <a href="reg_gestioneB1DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=anom%>">
                                <a href="reg_anomalieB1DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=liq%>">
                                <a href="reg_liquidazioneB1DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=esiti%>">
                                <a href="reg_esitiB1DT.jsp" class="nav-link nav-toggle">
