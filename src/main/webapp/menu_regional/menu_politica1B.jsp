...
<%
    ...
    String liq = "";
    String esiti = "";
    if (pageName.equals("reg_protocollo1B.jsp")) {
        prot = "active open";
    } else if (pageName.equals("reg_gestione1B.jsp")) {
        gest = "active open";
    } else if (pageName.equals("reg_anomalie1B.jsp")) {
        anom = "active open";
    } else if (pageName.equals("reg_liquidazione1B.jsp")) {
        liq = "active open";
    } else if (pageName.equals("reg_esiti1B.jsp")) {
        esiti = "active open";
    }
%>
                    ...
                    <li class="nav-item active open">
                        ...
                        <ul class="sub-menu">
                             <li class="nav-item start <%=prot%>">
                                <a href="reg_protocollo1B.jsp" class="nav-link nav-toggle">
                             ...
                             <li class="nav-item start <%=gest%>">
                                <a href="reg_gestione1B.jsp" class="nav-link nav-toggle">
                             ...
                             <li class="nav-item start <%=anom%>">
                                <a href="reg_anomalie1B.jsp" class="nav-link nav-toggle">
                             ...
                             <li class="nav-item start <%=liq%>">
                                <a href="reg_liquidazione1B.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=esiti%>">
                                <a href="reg_esiti1B.jsp" class="nav-link nav-toggle">
