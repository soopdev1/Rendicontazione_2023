...
<%String user = session.getAttribute("username").toString();
    ...
    String protocollo = "";
    String es = "";
    if (pageName.equals("regE_gestioneM5.jsp")) {
        elabora = "active open";
    } else if (pageName.equals("regE_liquidazioneM5.jsp")) {
        liquidazione = "active open";
    } else if (pageName.equals("regE_anomalieM5.jsp")) {
        anomalie = "active open";
    } else if (pageName.equals("regE_protocolloM5.jsp")) {
        protocollo = "active open";
    } else if (pageName.equals("regE_esitiM5.jsp")) {
        es = "active open";
    }
                            ...
                            <li class="nav-item start active open">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item start <%=protocollo%>">
                                        <a href="regE_protocolloM5.jsp" class="nav-link ">
                                    ...
                                    <li class="nav-item start <%=elabora%>" >
                                        <a href="regE_gestioneM5.jsp" class="nav-link ">
                                    ...
                                    <li class="nav-item start <%=liquidazione%>" >
                                        <a href="regE_liquidazioneM5.jsp"  class="nav-link ">
                                    ...
                                    <li class="nav-item start <%=anomalie%>" >
                                        <a href="regE_anomalieM5.jsp" class="nav-link ">
                                    ...
                                    <li class="nav-item start <%=es%>" >
                                        <a href="regE_esitiM5.jsp" class="nav-link ">
