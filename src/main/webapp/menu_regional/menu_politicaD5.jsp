...
<%
    ...
    String liq = "";
    String esiti = "";
    if (pageName.equals("reg_protocolloD5DT.jsp")) {
        prot = "active open";
    } else if (pageName.equals("reg_gestioneD5DT.jsp")) {
        gest = "active open";
    } else if (pageName.equals("reg_anomalieD5DT.jsp")) {
        anom = "active open";
    } else if (pageName.equals("reg_liquidazioneD5DT.jsp")) {
        liq = "active open";
    } else if (pageName.equals("reg_esitiD5DT.jsp")) {
        esiti = "active open";
    }
%>
            ...
            <li class="nav-item start active open">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item active open">
                        <a href="javascript:;" class="nav-link nav-toggle">
                            <i class="fa fa-arrow-down"></i> Politica D5
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub-menu">
                            <li class="nav-item start <%=prot%>">
                                <a href="reg_protocolloD5DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=gest%>">
                                <a href="reg_gestioneD5DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=anom%>">
                                <a href="reg_anomalieD5DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=liq%>">
                                <a href="reg_liquidazioneD5DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=esiti%>">
                                <a href="reg_esitiD5DT.jsp" class="nav-link nav-toggle">
