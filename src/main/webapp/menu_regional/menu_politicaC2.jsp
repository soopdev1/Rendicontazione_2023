...
<%
    ...
    String liq = "";
    String esiti = "";
    if (pageName.equals("reg_protocolloC2DT.jsp")) {
        prot = "active open";
    } else if (pageName.equals("reg_gestioneC2DT.jsp")) {
        gest = "active open";
    } else if (pageName.equals("reg_anomalieC2DT.jsp")) {
        anom = "active open";
    } else if (pageName.equals("reg_liquidazioneC2DT.jsp")) {
        liq = "active open";
    } else if (pageName.equals("reg_esitiC2DT.jsp")) {
        esiti = "active open";
    }
%>
            ...
            <li class="nav-item start active open">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item active open">
                        <a href="javascript:;" class="nav-link nav-toggle">
                            <i class="fa fa-arrow-down"></i> Politica C2
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub-menu">
                            <li class="nav-item start <%=prot%>">
                                <a href="reg_protocolloC2DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=gest%>">
                                <a href="reg_gestioneC2DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=anom%>">
                                <a href="reg_anomalieC2DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=liq%>">
                                <a href="reg_liquidazioneC2DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=esiti%>">
                                <a href="reg_esitiC2DT.jsp" class="nav-link nav-toggle">
