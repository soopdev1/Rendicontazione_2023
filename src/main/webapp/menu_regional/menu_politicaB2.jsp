...
<%
    ...
    String liq = "";
    String esiti = "";
    if (pageName.equals("reg_protocolloB2DT.jsp")) {
        prot = "active open";
    } else if (pageName.equals("reg_gestioneB2DT.jsp")) {
        gest = "active open";
    } else if (pageName.equals("reg_anomalieB2DT.jsp")) {
        anom = "active open";
    } else if (pageName.equals("reg_liquidazioneB2DT.jsp")) {
        liq = "active open";
    } else if (pageName.equals("reg_esitiB2DT.jsp")) {
        esiti = "active open";
    }
%>
            ...
            <li class="nav-item start active open">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item active open">
                        <a href="javascript:;" class="nav-link nav-toggle">
                            <i class="fa fa-arrow-down"></i> Politica B2
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub-menu">
                            <li class="nav-item start <%=prot%>">
                                <a href="reg_protocolloB2DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=gest%>">
                                <a href="reg_gestioneB2DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=anom%>">
                                <a href="reg_anomalieB2DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=liq%>">
                                <a href="reg_liquidazioneB2DT.jsp" class="nav-link nav-toggle">
                            ...
                            <li class="nav-item start <%=esiti%>">
                                <a href="reg_esitiB2DT.jsp" class="nav-link nav-toggle">
