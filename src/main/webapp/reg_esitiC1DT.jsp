...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "reg_esitiC1DT.jsp")) {
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->                    
                    <h3 class="page-title" style="color:#2D5F8B"><strong> C1 </strong>  <small style="color:#2D5F8B"> ESITI </small> </h3>    
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <div class="portlet box red-flamingo">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="reg_esitiC1DT.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="reg_esitiC1DT.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                ...
                                jQuery(document).ready(function () {
                                    var dt2 = function () {
                                        ...
                                        g.dataTable({
                                            ...
                                            processing: true,
                                            ajax: {
                                                url: "QueryRegional?type=31&politica=C1&ente=<%=ente%>&from=<%=from%>&to=<%=to%>&esito=<%=esito%>",
                                                dataSrc: "aaData",
                                                type: "GET"
                                            },
