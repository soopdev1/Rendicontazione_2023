...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "showPrgRimborso.jsp")) {
                            ...
                            jQuery(document).ready(function () {
                                var dt2 = function () {
                                    ...
                                    g.dataTable({
                                        ...
                                        processing: true,
                                        ajax: {
                                            url: "QueryEnte?type=9&politica=<%=request.getParameter("politica")%>&idrimborso=<%=request.getParameter("id")%>",
                                            dataSrc: "aaData",
                                            type: "GET"
                                        },
            ...
            jQuery(document).ready(function () {
                var dt2 = function () {
                    ...
                    g.dataTable({
                        ...
                        processing: true,
                        ajax: {
                            url: "QueryEnte?type=10&idrimborso=<%=request.getParameter("id")%>",
                            dataSrc: "aaData",
                            type: "GET"
                        },
                        drawCallback: function (settings, json) {
