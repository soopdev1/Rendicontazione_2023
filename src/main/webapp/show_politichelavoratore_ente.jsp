...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "show_politichelavoratore_ente.jsp")) {
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function showStatoRimborso(domanda_rimborso, cod) {
                $.get('OperazioniEnte?type=32&cod=' + cod + '&idrimborso=' + domanda_rimborso, function (response) {
                    if (response == "S") {
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content ">
                        <div class="modal-header bg-blue">
                            ...
                            <h4 class="modal-title">Stato Rimborso</h4>
                        </div>
                                        ...
                                        jQuery(document).ready(function () {
                                            var dt2 = function () {
                                                ...
                                                g.dataTable({
                                                    ...
                                                    processing: true,
                                                    ajax: {
                                                        url: "QueryEnte?type=33&idlav=<%=request.getParameter("idlav")%>",
                                                        dataSrc: "aaData",
                                                        type: "GET"
                                                    },
