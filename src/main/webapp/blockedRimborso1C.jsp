...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "blockedRimborso1C.jsp")) {
...
<html>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"><strong> 1C </strong><small> RESPINTE</small></h3>
                    ...
                    <div class="portlet box blue-soft" style="display: none;">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="blockedRimborso1C.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlForm();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="blockedRimborso1C.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <script type="text/javascript">
            ...
            <%if (true) {%>
                                ajax: {
                                url: "QueryEnte?type=3&stato=K&politica=B05&nome=<%=nome%>&cognome=<%=cognome%>&cf=<%=cf%>&from=<%=from%>&to=<%=to%>",
                                        dataSrc: "aaData",
                                        type: "GET"
                                },
            <%}%>
