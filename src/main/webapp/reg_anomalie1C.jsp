...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "reg_anomalie1C.jsp")) {
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function setIDAccettaRimborsi(id) {
                document.getElementById('confirmactive').href = 'OperazioniRegional?type=9&idrimborso=' + id + "&tipo=A1C";
            }
            ...
            function submitScarto2() {
                ...
                if (motivo12 == null || motivo12 == "..." || motivo12 == "") {
                    ...
                    if (motivo22 == "") {
                        ...
                        document.getElementById('conferma_scarta2').href = "OperazioniRegional?type=10&motivo=" + encodeURIComponent(motivo22) + "&idrimborso=" + $('#id_s2').val() + "&tipo=A1C";
                    }
                } else {
                    document.getElementById('conferma_scarta2').href = "OperazioniRegional?type=10&motivo=" + encodeURIComponent(motivo12) + "&idrimborso=" + $('#id_s2').val() + "&tipo=A1C";
                }
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->                    
                    <h3 class="page-title" style="color:#2D5F8B"><strong> 1C </strong>  <small style="color:#2D5F8B"> ANOMALIE </small> </h3>    
                                    ...
                                    jQuery(document).ready(function () {
                                        var dt2 = function () {
                                            ...
                                            g.dataTable({
                                                ...
                                                processing: true,
                                                ajax: {
                                                    url: "QueryRegional?type=7&politica=B05",
                                                    dataSrc: "aaData",
                                                    type: "GET"
                                                },
