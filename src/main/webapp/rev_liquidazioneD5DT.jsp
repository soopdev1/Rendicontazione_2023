...
<%
    if (session.getAttribute("username") == null) {
        ...
        if (!Action.isVisibile(stat, "rev_liquidazioneD5DT.jsp")) {
            ...
            function submitScarto() {
                ...
                if (motivo == null || motivo == "..." || motivo == "") {
                    ...
                    if (motivo2 == "") {
                        ...
                        document.getElementById('conferma_scarta').href = "OperazioniRevisore?type=14&motivo=" + encodeURIComponent(motivo2) + "&idrimborso=" + $('#id_s').val() + "&pagina=rev_liquidazioneD5DT"
                        + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                    }
                } else {
                    document.getElementById('conferma_scarta').href = "OperazioniRevisore?type=14&motivo=" + encodeURIComponent(motivo) + "&idrimborso=" + $('#id_s').val() + "&pagina=rev_liquidazioneD5DT"
                    + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                }
            ...
            function submitScarto2() {
                ...
                if (motivo1 == null || motivo1 == "..." || motivo1 == "") {
                    ...
                    if (motivo12 == "") {
                        ...
                        document.getElementById('conferma_scarta1').href = "OperazioniRevisore?type=15&motivo=" + encodeURIComponent(motivo12) + "&idrimborso=" + $('#id_s2').val() + "&pagina=rev_liquidazioneD5DT"
                        + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                    }
                } else {
                    document.getElementById('conferma_scarta1').href = "OperazioniRevisore?type=15&motivo=" + encodeURIComponent(motivo1) + "&idrimborso=" + $('#id_s2').val() + "&pagina=rev_liquidazioneD5DT"
                    + "&ente=<%=ente%>&from=<%=from%>&to=<%=to%>";
                }
...
//            }
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content ">
                    ...
                    <form class="form-horizontal" action="<%="OperazioniRevisore?type=15"%>" method="post" enctype="multipart/form-data" onsubmit="return ctrlFormScarto();">
                        ...
                        <input type="hidden" id="pagina" name="pagina" value="rev_liquidazioneD5DT">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu_revisore/menu_politicaD5.jsp"%>
            <!-- END MENU -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->                    
                    <h3 class="page-title font-blue-chambray"><strong> D5 </strong>  <small class="font-blue-chambray"> AMMISSIBILITÀ INDENNITÀ </small> </h3>    
                    ...
                    <div class="portlet box purple-seance">
                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" action="rev_liquidazioneD5DT.jsp" method="post" name="form" accept-charset="ISO-8859-1" onsubmit="return ctrlRicerca();">
                                ...
                                <div class="form-body" id="div_form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <a href="rev_liquidazioneD5DT.jsp" class="btn red-thunderbird btn-outline"><i class="fa fa-close"></i> Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                ...
                jQuery(document).ready(function () {
                    var dt2 = function () {
                        ...
                        g.dataTable({
                            ...
                            processing: true,
                            ajax: {
                                url: "QueryRevisore?type=1&politica=D5&ente=<%=ente%>&from=<%=from%>&to=<%=to%>",
                                dataSrc: "aaData",
                                type: "GET"
                            },
